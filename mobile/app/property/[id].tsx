        ...
        <ScrollView style={styles.modalContent}>
            ...
            <View style={styles.radioGroup}>
              {propertyTypes.map((type) => (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setEditedProperty({ ...editedProperty, type: type.value })
                  }
                >
                  <MaterialCommunityIcons
                    ...
                    size={20}
                    color={
                      editedProperty.type === type.value ? "#3B82F6" : "#6B7280"
                    }
                  />
                  <Text
                    style={[
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setEditedProperty({ ...editedProperty, street1: text })
              }
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setEditedProperty({ ...editedProperty, street2: text })
              }
          ...
          <View style={styles.formRow}>
            <View style={[styles.formGroup, { flex: 2 }]}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setEditedProperty({ ...editedProperty, city: text })
                }
                placeholder="City"
                placeholderTextColor="#6B7280"
              />
          ...
          <View style={styles.formRow}>
            <View style={[styles.formGroup, { flex: 1 }]}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setEditedProperty({ ...editedProperty, zip: text })
                }
                placeholder="33901"
                placeholderTextColor="#6B7280"
            ...
            <View style={[styles.formGroup, { flex: 2 }]}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setEditedProperty({ ...editedProperty, county: text })
                }
                placeholder="Lee"
                placeholderTextColor="#6B7280"
              />
            ...
            <View style={styles.formGroup}>
              ...
              <View style={styles.coordinatesContainer}>
                <Text style={styles.coordinatesText}>
                  {editedProperty.latitude?.toFixed(6)},{" "}
                  {editedProperty.longitude?.toFixed(6)}
                </Text>
                <TouchableOpacity
                  onPress={() => {
                    ...
                    Alert.alert(
                      "Update Location",
                      "This would update with current GPS coordinates",
                    );
                  }}
                >
                  <MaterialCommunityIcons
...
export default function PropertyDetailScreen() {
  ...
  const propertyAssessments = assessments.items.filter(
    (a) => a.property_id === id,
  );
    ...
    <View style={styles.container}>
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.addressText}>{property.county} County</Text>
        ...
        <View style={styles.section}>
          ...
          {propertyAssessments.length === 0 ? (
            <View style={styles.emptyAssessments}>
              <MaterialCommunityIcons
                ...
                color="#6B7280"
              />
              <Text style={styles.emptyAssessmentsText}>
                No assessments yet
              </Text>
          ...
          >
            <MaterialCommunityIcons
              ...
              color="white"
            />
            <Text style={styles.startAssessmentButtonText}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickActions}>
            <TouchableOpacity
              ...
              onPress={() =>
                router.push(
                  `/camera?return_screen=property&property_id=${property.id}`,
                )
              }
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Alert.alert(
                  "Coming Soon",
                  "Voice notes will be available in the next update",
                )
              }
            >
              <MaterialCommunityIcons
