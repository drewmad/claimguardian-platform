...
export default function PropertiesScreen() {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      Alert.alert('Sync Failed', 'Unable to sync properties. Please try again later.')
    } finally {
      setRefreshing(false)
    }
  }
  ...
  const uniqueCounties = [...new Set(properties.items.map(p => p.county))].sort()
  const propertyTypes: Property['type'][] = ['single_family', 'condo', 'townhouse', 'mobile_home', 'commercial']
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {showFilters && (
          <View style={styles.filtersContainer}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              ...
              >
                <Text style={[
                  ...
                  !properties.filters.propertyType && styles.filterChipTextActive
                ]}>
                  All Types
                </Text>
              </TouchableOpacity>
              ...
              {propertyTypes.map(type => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterChip,
                    properties.filters.propertyType === type && styles.filterChipActive
                  ]}
                  onPress={() => dispatch(setPropertyTypeFilter(type))}
                >
                  <Text style={[
                    styles.filterChipText,
                    properties.filters.propertyType === type && styles.filterChipTextActive
                  ]}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.countyFilters}>
              <TouchableOpacity
                style={[
                  styles.filterChip,
              ...
              {uniqueCounties.map(county => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterChip,
                    properties.filters.county === county && styles.filterChipActive
                  ]}
                  onPress={() => dispatch(setCountyFilter(county))}
                >
                  <Text style={[
                    styles.filterChipText,
                    properties.filters.county === county && styles.filterChipTextActive
                  ]}>
                    {county} County
                  </Text>
                </TouchableOpacity>
      ...
      {!network.isConnected && (
        <View style={styles.offlineBanner}>
          <MaterialCommunityIcons name="cloud-off-outline" size={16} color="#F59E0B" />
      ...
      >
        {sortedProperties.length === 0 ? (
          <View style={styles.emptyState}>
            <MaterialCommunityIcons name="home-plus" size={64} color="#6B7280" />
            <Text style={styles.emptyStateTitle}>
              {properties.filters.searchQuery || properties.filters.propertyType || properties.filters.county
                ? 'No Properties Found'
                : 'No Properties Yet'
              }
            </Text>
