...
import { createAssessment } from "../../../shared/store/slices/assessmentsSlice";
...
const WIND_SPEEDS = [
  "Calm (0-5 mph)",
  "Light Breeze (6-15 mph)",
  "Moderate Breeze (16-25 mph)",
  "Strong Breeze (26-35 mph)",
  "High Wind (36+ mph)",
];
...
const OVERALL_CONDITIONS: Array<{
  value: DamageAssessment["overall_condition"];
  label: string;
  color: string;
}> = [
...
const PRIORITY_LEVELS: Array<{
  value: DamageAssessment["priority_level"];
  label: string;
  color: string;
}> = [
    ...
    <View style={styles.stepContent}>
      ...
      <View style={styles.propertyCard}>
        <View style={styles.propertyCardHeader}>
          ...
          <View style={styles.propertyCardInfo}>
            ...
            <Text style={styles.propertyCardType}>
        ...
        {location.current && (
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoValue}>
                {location.current.latitude.toFixed(6)},{" "}
                {location.current.longitude.toFixed(6)}
              </Text>
            </View>
          </View>
        )}
      ...
      <View style={styles.tipBox}>
        ...
        <Text style={styles.tipText}>
          Ensure you're at the property location and have good lighting before
              ...
              onPress={() => {
                Alert.alert(
                  ...
                  WIND_SPEEDS.map((speed) => ({
                    text: speed,
                    onPress: () =>
                      setFormData({ ...formData, wind_speed: speed }),
                  })),
                );
              }}
            >
      ...
      <View style={styles.formSection}>
            ...
            <View style={styles.conditionPreview}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      OVERALL_CONDITIONS.find(
                        (c) => c.value === formData.overall_condition,
                      )?.color || "#6B7280",
                  },
                ]}
              />
        ...
        <View style={styles.inputGroup}>
          ...
          <Text style={styles.inputHelper}>
            Current estimate: $
            {formData.estimated_total_damage.toLocaleString()}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.switchGroup}>
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              ...
              <Text style={styles.switchDescription}>
                Immediate safety hazards present
              </Text>
            </View>
            <Switch
              value={formData.safety_concerns}
              onValueChange={(value) =>
                setFormData({ ...formData, safety_concerns: value })
              }
          ...
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              ...
              <Text style={styles.switchDescription}>
                Difficulty accessing areas
              </Text>
            </View>
            <Switch
              value={formData.access_issues}
              onValueChange={(value) =>
                setFormData({ ...formData, access_issues: value })
              }
              trackColor={{ false: "#374151", true: "#3B82F6" }}
          ...
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              ...
              <Text style={styles.switchDescription}>
                Power, water, or gas issues
              </Text>
            </View>
            <Switch
              value={formData.utility_concerns}
              onValueChange={(value) =>
                setFormData({ ...formData, utility_concerns: value })
              }
              trackColor={{ false: "#374151", true: "#3B82F6" }}
                  ...
                  styles.conditionDot,
                  {
                    backgroundColor:
                      PRIORITY_LEVELS.find(
                        (p) => p.value === formData.priority_level,
                      )?.color || "#6B7280",
                  },
                ]}
              />
        ...
        <View style={styles.switchGroup}>
          <View style={styles.switchRow}>
            ...
            <Switch
              ...
              onValueChange={(value) =>
                setFormData({ ...formData, immediate_action_needed: value })
              }
              trackColor={{ false: "#374151", true: "#EF4444" }}
              thumbColor={
                formData.immediate_action_needed ? "#FFFFFF" : "#9CA3AF"
              }
            />
          </View>
        </View>
