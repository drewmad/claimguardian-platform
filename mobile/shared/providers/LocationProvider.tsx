...
export function LocationProvider({ children }: LocationProviderProps) {
  ...
  useEffect(() => {
    const handleAppStateChange = (nextAppState: string) => {
      ...
      if (
        ...
        locationState.settings.backgroundTracking
      ) {
  ...
  useEffect(() => {
    ...
    locationState.current?.accuracy,
    locationState.settings.highAccuracyMode,
  ]);
  ...
  useEffect(() => {
    if (
      ...
      console.log(
        "Background location tracking with high accuracy enabled - may affect battery life",
      );
    }
  }, [
    locationState.settings.backgroundTracking,
