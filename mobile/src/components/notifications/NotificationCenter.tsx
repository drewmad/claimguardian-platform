      ...
      switch (notification.type) {
        ...
        case "assessment_update":
          ...
          navigation.navigate("AssessmentDetail", {
            id: notification.data.assessmentId,
          });
          break;
        case "weather_warning":
          // Navigate to weather details
          navigation.navigate("WeatherAlert", {
            alertId: notification.data.alertId,
          });
          break;
        default:
            ...
            <View style={styles.section}>
              ...
              <View style={styles.settingItem}>
                ...
                <Switch
                  ...
                  onValueChange={(value) =>
                    updateSetting("disasterAlerts", value)
                  }
              ...
              <View style={styles.settingItem}>
                ...
                <Switch
                  ...
                  onValueChange={(value) =>
                    updateSetting("weatherWarnings", value)
                  }
                  trackColor={{ false: "#333", true: "#4CAF50" }}
                  thumbColor="#fff"
                />
              ...
              <View style={styles.settingItem}>
                ...
                <Switch
                  ...
                  onValueChange={(value) =>
                    updateSetting("assessmentUpdates", value)
                  }
                  trackColor={{ false: "#333", true: "#4CAF50" }}
                  thumbColor="#fff"
                />
              ...
              <View style={styles.settingItem}>
                ...
                <Switch
                  ...
                  onValueChange={(value) =>
                    updateSetting("syncNotifications", value)
                  }
                  trackColor={{ false: "#333", true: "#4CAF50" }}
                  thumbColor="#fff"
                />
            ...
            <View style={styles.section}>
              ...
              <View style={styles.settingItem}>
                ...
                <Switch
                  ...
                  onValueChange={(value) =>
                    updateSetting("locationBasedAlerts", value)
                  }
                  trackColor={{ false: "#333", true: "#4CAF50" }}
                  thumbColor="#fff"
                />
        ...
        <SafeAreaView style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>
              Stay informed with real-time disaster alerts, weather warnings,
              and important updates about your assessments.
            </Text>
