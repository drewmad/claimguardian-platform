...
export function PhotoReviewScreen() {
  ...
  const { photoId, assessmentId } = route.params as {
    photoId: string;
    assessmentId?: string;
  };
  ...
  const [selectedAnnotation, setSelectedAnnotation] =
    useState<DamageAnnotation | null>(null);
  ...
  const handleAIAnalysis = useCallback(async () => {
    ...
    try {
      ...
      Alert.alert(
        "Analysis Complete",
        "AI damage analysis has been completed and annotations added.",
      );
    } catch (error) {
      console.error("AI analysis failed:", error);
      Alert.alert(
        "Analysis Failed",
        "Could not complete AI damage analysis. Please try again.",
      );
    } finally {
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.annotationMarker,
                  {
                    ...
                    height:
                      (annotation.height / 100) * displayDimensions.height,
