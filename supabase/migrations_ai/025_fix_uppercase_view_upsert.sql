-- Fix UPPERCASE view for proper UPSERT handling
-- =============================================

-- Drop existing view and trigger
...
-- Create a simpler INSTEAD OF INSERT trigger
...
-- Add helpful comment
COMMENT ON VIEW florida_parcels_uppercase IS 'Import view for CSV files with UPPERCASE column headers. Use this view when importing Florida parcel data from CSV files. The view automatically maps uppercase columns to lowercase and derives county_fips from CO_NO.';