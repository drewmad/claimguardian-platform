-- Handle Florida Parcels Table with Complete Schema
-- =================================================

-- First, backup existing data if any
CREATE TABLE IF NOT EXISTS florida_parcels_backup AS 
SELECT * FROM florida_parcels WHERE false;

-- Insert any existing data into backup
INSERT INTO florida_parcels_backup 
SELECT * FROM florida_parcels 
WHERE EXISTS (SELECT 1 FROM florida_parcels LIMIT 1);
