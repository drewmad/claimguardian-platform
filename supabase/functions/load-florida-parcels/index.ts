...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Loading Florida parcels - County: ${county || 'All'}, Offset: ${offset}, Limit: ${limit}`)
    ...
    const params = {
      ...
      outFields: 'PARCEL_ID,CO_NO,COUNTY,SITUS_ADDR,OWN_NAME,OWN_ADDR,DOR_UC,JV,TV_NSD,YR_BLT,LV_SF,ACRES',
      f: 'json',
      resultOffset: offset,
