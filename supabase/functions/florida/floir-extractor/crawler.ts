...
export class FLOIRCrawler {
  ...
  private async ensurePlaywright() {
    if (!this.playwright) {
      ...
      const { chromium } = await import(
        "https://deno.land/x/playwright@1.40.0/mod.ts"
      );
  ...
  private async crawlCatastrophe(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
  ...
  private async crawlIndustryReports(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
    ...
    const data = await page.evaluate(() => {
      ...
      pdfLinks.forEach((link) => {
        ...
        if (href && yearMatch) {
          results.push({
            Year: yearMatch[1],
            ReportPDF: href.startsWith("http")
              ? href
  ...
  private async crawlProfessionalLiability(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
  ...
  private async crawlRateFilings(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
  ...
  private async crawlReceivership(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
  ...
  private async crawlNewsBulletins(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
  ...
  private async crawlLicenseeSearch(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
  ...
  private async crawlFinancialReports(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
  ...
  private async crawlSurplusLines(
    page: any,
    config: any,
    query: any,
  ): Promise<any[]> {
