...
function calculateRoomHeight(floorPoints: ARScanPoint[], wallPoints: ARScanPoint[]): number {
...
function calculateScanCoverage(points: ARScanPoint[], roomArea: number): number {
...
function generateFloorPlan(rooms: Array<{ measurements: RoomMeasurement; type: string; sessionId: string }>): FloorPlanData {
  let totalArea = 0
