...
> = {
  1: {
    name: "ALACHUA",
    population: 278468,
    parcels_estimate: 110000,
    area_sqmi: 969,
    region: "North Central",
    major_cities: ["Gainesville"],
  },
  2: {
    name: "BAKER",
    population: 28259,
    parcels_estimate: 12000,
    area_sqmi: 588,
    region: "Northeast",
    major_cities: ["Macclenny"],
  },
  3: {
    name: "BAY",
    population: 175216,
    parcels_estimate: 85000,
    area_sqmi: 1033,
    region: "Panhandle",
  ...
  5: {
    name: "BREVARD",
    population: 606612,
    parcels_estimate: 280000,
    area_sqmi: 1557,
    region: "East Central",
    major_cities: ["Melbourne", "Palm Bay", "Titusville"],
  },
  6: {
    name: "BROWARD",
    population: 1944375,
    parcels_estimate: 720000,
    area_sqmi: 1320,
    region: "Southeast",
    major_cities: ["Fort Lauderdale", "Hollywood", "Pembroke Pines"],
  },
  7: {
    name: "CALHOUN",
    population: 13648,
    parcels_estimate: 8000,
    area_sqmi: 574,
    region: "Panhandle",
    major_cities: ["Blountstown"],
  },
  8: {
    name: "CHARLOTTE",
    population: 188910,
    parcels_estimate: 343620,
    area_sqmi: 859,
    region: "Southwest",
    major_cities: ["Port Charlotte", "Punta Gorda"],
  },
  9: {
    name: "CITRUS",
    population: 153843,
    parcels_estimate: 95000,
    area_sqmi: 773,
    region: "West Central",
    major_cities: ["Inverness", "Crystal River"],
  },
  10: {
    name: "CLAY",
    population: 218245,
    ...
    area_sqmi: 644,
    region: "Northeast",
    major_cities: ["Orange Park", "Green Cove Springs"],
  },
  11: {
    name: "COLLIER",
    population: 375752,
    parcels_estimate: 200000,
    area_sqmi: 2305,
    region: "Southwest",
    major_cities: ["Naples", "Marco Island"],
  },
  12: {
    name: "COLUMBIA",
    population: 69698,
    parcels_estimate: 35000,
    area_sqmi: 801,
    region: "North Central",
    major_cities: ["Lake City"],
  },
  13: {
    name: "MIAMI-DADE",
    population: 2716940,
    parcels_estimate: 950000,
    area_sqmi: 2431,
    region: "Southeast",
    major_cities: ["Miami", "Hialeah", "Miami Beach"],
  },
  14: {
    name: "DESOTO",
    population: 35440,
    parcels_estimate: 18000,
    area_sqmi: 639,
    region: "Southwest",
    major_cities: ["Arcadia"],
  },
  15: {
    name: "DIXIE",
    population: 16759,
    ...
    area_sqmi: 864,
    region: "North Central",
    major_cities: ["Cross City"],
  },
  16: {
    name: "DUVAL",
    population: 995298,
    parcels_estimate: 380000,
    area_sqmi: 918,
    region: "Northeast",
    major_cities: ["Jacksonville"],
  },
  17: {
    name: "ESCAMBIA",
    population: 321905,
    parcels_estimate: 145000,
    area_sqmi: 875,
    region: "Panhandle",
    major_cities: ["Pensacola"],
  },
  18: {
    name: "FLAGLER",
    population: 115378,
    parcels_estimate: 65000,
    area_sqmi: 571,
    region: "Northeast",
    major_cities: ["Palm Coast"],
  },
  19: {
    name: "FRANKLIN",
    population: 12125,
    parcels_estimate: 15000,
    area_sqmi: 1026,
    region: "Panhandle",
    major_cities: ["Apalachicola"],
  },
  20: {
    name: "GADSDEN",
    population: 45660,
    parcels_estimate: 22000,
    area_sqmi: 529,
    region: "Panhandle",
    major_cities: ["Quincy"],
  },
  21: {
    name: "GILCHRIST",
    population: 18582,
    parcels_estimate: 10000,
    area_sqmi: 353,
    region: "North Central",
    major_cities: ["Trenton"],
  },
  22: {
    name: "GLADES",
    population: 13811,
  ...
  23: {
    ...
    area_sqmi: 745,
    region: "Panhandle",
    major_cities: ["Port St. Joe"],
  },
  24: {
    name: "HAMILTON",
    population: 14428,
    parcels_estimate: 7000,
    area_sqmi: 519,
    region: "North Central",
    major_cities: ["Jasper"],
  },
  ...
  26: {
    ...
    area_sqmi: 1190,
    region: "South Central",
    major_cities: ["LaBelle", "Clewiston"],
  },
  27: {
    name: "HERNANDO",
    population: 194515,
    ...
    area_sqmi: 589,
    region: "West Central",
    major_cities: ["Brooksville", "Spring Hill"],
  },
  28: {
    name: "HIGHLANDS",
    population: 101235,
    parcels_estimate: 60000,
    area_sqmi: 1106,
    region: "Central",
    major_cities: ["Sebring", "Avon Park"],
  },
  29: {
    name: "HILLSBOROUGH",
    population: 1459762,
    parcels_estimate: 520000,
    area_sqmi: 1266,
    region: "West Central",
    major_cities: ["Tampa", "Brandon", "Plant City"],
  },
  30: {
    name: "HOLMES",
    population: 19653,
    parcels_estimate: 11000,
    area_sqmi: 489,
    region: "Panhandle",
    major_cities: ["Bonifay"],
  },
  31: {
    name: "INDIAN RIVER",
    population: 159923,
    ...
    area_sqmi: 617,
    region: "East Central",
    major_cities: ["Vero Beach", "Sebastian"],
  },
  32: {
    name: "JACKSON",
    population: 47409,
    parcels_estimate: 25000,
    area_sqmi: 955,
    region: "Panhandle",
    major_cities: ["Marianna"],
  },
  33: {
    name: "JEFFERSON",
    population: 14510,
  ...
  35: {
    name: "LAKE",
    population: 383956,
    parcels_estimate: 180000,
    area_sqmi: 1156,
    region: "Central",
    major_cities: ["Leesburg", "Eustis", "Clermont"],
  },
  36: {
    name: "LEE",
    population: 760822,
    ...
    area_sqmi: 1212,
    region: "Southwest",
    major_cities: ["Fort Myers", "Cape Coral"],
  },
  37: {
    name: "LEON",
    population: 293582,
    parcels_estimate: 120000,
    area_sqmi: 702,
    region: "Panhandle",
    major_cities: ["Tallahassee"],
  },
  38: {
    name: "LEVY",
    population: 42915,
    parcels_estimate: 28000,
    area_sqmi: 1412,
    region: "North Central",
    major_cities: ["Chiefland", "Williston"],
  },
  39: {
    name: "LIBERTY",
    population: 7974,
    ...
    area_sqmi: 843,
    region: "Panhandle",
    major_cities: ["Bristol"],
  },
  40: {
    name: "MADISON",
    population: 18493,
    parcels_estimate: 9000,
    area_sqmi: 716,
    region: "North Central",
    major_cities: ["Madison"],
  },
  41: {
    name: "MANATEE",
    population: 399710,
    parcels_estimate: 185000,
    area_sqmi: 893,
    region: "Southwest",
    major_cities: ["Bradenton", "Palmetto"],
  },
  42: {
    name: "MARION",
    population: 375908,
  ...
  44: {
    name: "MONROE",
    population: 82874,
    parcels_estimate: 55000,
    area_sqmi: 3737,
    region: "South",
    major_cities: ["Key West", "Marathon"],
  },
  45: {
    name: "NASSAU",
    population: 90352,
    parcels_estimate: 45000,
    area_sqmi: 726,
    region: "Northeast",
    major_cities: ["Fernandina Beach", "Yulee"],
  },
  46: {
    name: "OKALOOSA",
    population: 211668,
    ...
    area_sqmi: 1082,
    region: "Panhandle",
    major_cities: ["Fort Walton Beach", "Destin", "Crestview"],
  },
  47: {
    name: "OKEECHOBEE",
    population: 39476,
    parcels_estimate: 20000,
    area_sqmi: 892,
    region: "South Central",
    major_cities: ["Okeechobee"],
  },
  48: {
    name: "ORANGE",
    population: 1429908,
    parcels_estimate: 480000,
    area_sqmi: 1003,
    region: "Central",
    major_cities: ["Orlando", "Apopka", "Winter Park"],
  },
  49: {
    name: "OSCEOLA",
    population: 388656,
    ...
    area_sqmi: 1506,
    region: "Central",
    major_cities: ["Kissimmee", "St. Cloud"],
  },
  50: {
    name: "PALM BEACH",
    population: 1492191,
    parcels_estimate: 650000,
    area_sqmi: 2383,
    region: "Southeast",
    major_cities: ["West Palm Beach", "Boca Raton", "Boynton Beach"],
  },
  51: {
    name: "PASCO",
    population: 561891,
    parcels_estimate: 240000,
    area_sqmi: 868,
    region: "West Central",
    major_cities: ["New Port Richey", "Land O' Lakes"],
  },
  52: {
    name: "PINELLAS",
    population: 959107,
    ...
    area_sqmi: 608,
    region: "West Central",
    major_cities: ["St. Petersburg", "Clearwater", "Largo"],
  },
  53: {
    name: "POLK",
    population: 724777,
    parcels_estimate: 290000,
    area_sqmi: 2010,
    region: "Central",
    major_cities: ["Lakeland", "Winter Haven", "Bartow"],
  },
  54: {
    name: "PUTNAM",
    population: 73321,
    parcels_estimate: 40000,
    area_sqmi: 827,
    region: "Northeast",
    major_cities: ["Palatka"],
  },
  55: {
    name: "ST. JOHNS",
    population: 273425,
    parcels_estimate: 115000,
    area_sqmi: 822,
    region: "Northeast",
    major_cities: ["St. Augustine", "St. Johns"],
  },
  56: {
    name: "ST. LUCIE",
    population: 329226,
    ...
    area_sqmi: 688,
    region: "Southeast",
    major_cities: ["Port St. Lucie", "Fort Pierce"],
  },
  57: {
    name: "SANTA ROSA",
    population: 188000,
    ...
    area_sqmi: 1174,
    region: "Panhandle",
    major_cities: ["Milton", "Navarre"],
  },
  58: {
    name: "SARASOTA",
    population: 434006,
    parcels_estimate: 220000,
    area_sqmi: 725,
    region: "Southwest",
    major_cities: ["Sarasota", "Venice", "North Port"],
  },
  59: {
    name: "SEMINOLE",
    population: 470856,
    ...
    area_sqmi: 345,
    region: "Central",
    major_cities: ["Sanford", "Altamonte Springs"],
  },
  60: {
    name: "SUMTER",
    population: 129752,
    ...
    area_sqmi: 580,
    region: "Central",
    major_cities: ["The Villages", "Wildwood"],
  },
  61: {
    name: "SUWANNEE",
    population: 43474,
  ...
  64: {
    ...
    area_sqmi: 1432,
    region: "East Central",
    major_cities: ["Daytona Beach", "Deltona", "Port Orange"],
  },
  65: {
    name: "WAKULLA",
    population: 33764,
  ...
  66: {
    ...
    area_sqmi: 1238,
    region: "Panhandle",
    major_cities: ["DeFuniak Springs", "Santa Rosa Beach"],
  },
  67: {
    name: "WASHINGTON",
    population: 25473,
    parcels_estimate: 14000,
    area_sqmi: 616,
    region: "Panhandle",
    major_cities: ["Chipley"],
  },
};
  ...
  for (const log of logs || []) {
    ...
    if (stats) {
      ...
      if (log.started_at && log.completed_at) {
        ...
        stats.parcels_per_minute =
          minutes > 0 ? Math.round(log.processed_parcels / minutes) : 0;
      }

      // Calculate density metrics
      stats.parcels_per_capita =
        stats.population > 0
...
async function getEnhancedTimeline(
  supabase: any,
  limit: number,
): Promise<Response> {
  ...
  const timelineStats = {
    events_in_last_hour: timeline.filter(
      (e: any) => new Date(e.timestamp).getTime() > Date.now() - 3600000,
    ).length,
    average_processing_rate: Math.round(
      timeline.reduce((sum: number, e: any) => sum + e.processing_rate, 0) /
        timeline.length || 1,
    ),
...
async function getDetailedPerformance(supabase: any): Promise<Response> {
    ...
    completedLogs?.map((log: any) => {
      ...
      const parcelsPerMinute =
        durationMinutes > 0
          ...
          : 0;
      const parcelsPerBatch =
        log.batch_size > 0
          ? Math.round(log.processed_parcels / log.batch_size)
          : 0;
      ...
      return {
        ...
        throughput_mbps: calculateThroughput(
          log.processed_parcels,
          durationMinutes,
        ),
  ...
  const performanceAnalysis = {
    ...
    optimization_recommendations:
      getOptimizationRecommendations(countyPerformance),
  };
  ...
  return new Response(
    JSON.stringify({
      summary,
      county_performance: countyPerformance.sort(
...
async function getDetailedCountyInfo(
  supabase: any,
  countyCode?: number,
): Promise<Response> {
  if (!countyCode) {
    return new Response(JSON.stringify({ error: "County code required" }), {
      headers: { ...corsHeaders, "Content-Type": "application/json" },
      status: 400,
    });
  }
  ...
  const detailedInfo = {
    ...
    data_quality: {
      completeness_score: calculateCompletenessScore(
        parcelCount || 0,
        countyInfo?.parcels_estimate || 0,
      ),
      error_rate:
        processingLog?.error_count > 0
          ? ((processingLog.error_count / (parcelCount || 1)) * 100).toFixed(
              2,
            ) + "%"
          : "0%",
...
async function getRegionalAnalysis(
  ...
  const regionalAnalysis = Object.entries(regionGroups).map(
    ([regionName, counties]) => {
      const completed = counties.filter(
        (c: any) => c.status === "completed",
      ).length;
      const processing = counties.filter(
        (c: any) => c.status === "processing",
      ).length;
      const totalParcels = counties.reduce(
        (sum: number, c: any) => sum + c.parcels_processed,
        0,
      );
      const estimatedParcels = counties.reduce(
        (sum: number, c: any) => sum + c.estimated_parcels,
        0,
      );
      const totalPopulation = counties.reduce(
        (sum: number, c: any) => sum + c.population,
        0,
      );
      const totalArea = counties.reduce(
        (sum: number, c: any) => sum + c.area_sqmi,
        0,
      );
  ...
  return new Response(
    JSON.stringify({
      ...
      summary: {
        ...
        most_complete: regionalAnalysis.sort(
          (a, b) => b.progress - a.progress,
        )[0],
        least_complete: regionalAnalysis.sort(
          (a, b) => a.progress - b.progress,
        )[0],
        highest_density: regionalAnalysis.sort(
...
function calculatePredictions(counties: any[]): any {
  ...
  const avgRate =
    completedCounties.length > 0
      ? completedCounties.reduce(
          (sum, c) => sum + (c.parcels_per_minute || 0),
          0,
        ) / completedCounties.length
      : 500; // Default estimate

  // Estimate remaining time
  const remainingParcels = pendingCounties.reduce(
    (sum, c) => sum + (c.estimated_parcels || 0),
    0,
  );
...
function calculateEnhancedPerformance(completedCounties: any[]): any {
  ...
  const totalParcels = completedCounties.reduce(
    (sum, c) => sum + c.actual_parcels,
    0,
  );
  const totalMinutes = completedCounties.reduce(
    (sum, c) => sum + c.processing_time,
    0,
  );
  ...
  return {
    average_processing_time_minutes: Math.round(
      totalMinutes / completedCounties.length,
    ),
    average_parcels_per_minute: avgParcelsPerMinute,
    fastest_county: completedCounties.sort(
      (a, b) => b.parcels_per_minute - a.parcels_per_minute,
    )[0],
    slowest_county: completedCounties.sort(
      (a, b) => a.parcels_per_minute - b.parcels_per_minute,
    )[0],
    optimal_batch_size: 1000, // Could be calculated based on performance data
    median_processing_time: calculateMedian(
      completedCounties.map((c) => c.processing_time),
    ),
    standard_deviation: calculateStandardDeviation(
      completedCounties.map((c) => c.parcels_per_minute),
    ),
  };
}

function getMostActiveRegion(timeline: any[]): string {
  const regionCounts = timeline.reduce(
...
function identifyErrorPatterns(errors: any[], systemLogs: any[]): any {
  ...
  const patterns = {
    timeout_errors: errors.filter((e) => e.error_message?.includes("timeout"))
      .length,
    connection_errors: errors.filter((e) =>
      e.error_message?.includes("connection"),
    ).length,
    data_errors: errors.filter(
      (e) =>
        e.error_message?.includes("invalid") ||
        e.error_message?.includes("null"),
    ).length,
    permission_errors: errors.filter(
      (e) =>
        e.error_message?.includes("permission") ||
        e.error_message?.includes("denied"),
    ).length,
  };
  ...
  return {
    ...
    most_common:
      ...
      "unknown",
    system_issues:
      systemLogs?.filter((log: any) => log.level === "error").length || 0,
  };
}
...
function calculateRecoveryTime(errors: any[]): number {
  ...
  const complexityMultiplier = errors.some((e) => e.error_type === "error")
    ? 2
    : 1;
...
function calculateCost(parcels: number, minutes: number): number {
  ...
  const computeCost = (minutes / 60) * 0.1; // $0.10 per hour
  const dataCost = (parcels / 1000000) * 0.5; // $0.50 per million
...
function analyzeByRegion(performance: any[]): any {
  ...
  return Object.entries(regions).map(([region, counties]) => ({
    ...
    average_speed: Math.round(
      counties.reduce((sum: number, c: any) => sum + c.parcels_per_minute, 0) /
        counties.length,
    ),
    total_parcels: counties.reduce(
      (sum: number, c: any) => sum + c.parcels_processed,
      0,
    ),
    average_efficiency: Math.round(
      counties.reduce((sum: number, c: any) => sum + c.efficiency_score, 0) /
        counties.length,
    ),
  }));
}
...
function analyzeByBatchSize(performance: any[]): any {
  ...
  return Object.entries(batchGroups).map(([size, counties]: [string, any]) => ({
    ...
    average_errors: Math.round(
      counties.reduce((sum: number, c: any) => sum + c.errors, 0) /
        counties.length,
    ),
  }));
}
...
function getOptimizationRecommendations(performance: any[]): string[] {
  ...
  const avgSpeed =
    performance.reduce((sum, c) => sum + c.parcels_per_minute, 0) /
    performance.length;
  const avgErrors =
    performance.reduce((sum, c) => sum + c.errors, 0) / performance.length;
  ...
  if (avgErrors > 10) {
    recommendations.push(
      "High error rate detected - implement data validation preprocessing",
    );
  }
  if (performance.some((p) => p.duration_minutes > 120)) {
    recommendations.push(
      "Some counties taking over 2 hours - consider parallel processing",
    );
  }

  // Analyze batch size performance
  const batchSizePerformance = analyzeByBatchSize(performance);
  const optimalBatch = batchSizePerformance.sort(
    (a, b) => b.average_speed - a.average_speed,
  )[0];
  if (optimalBatch && optimalBatch.batch_size !== 1000) {
    recommendations.push(
      `Optimal batch size appears to be ${optimalBatch.batch_size}`,
    );
  }
...
function calculateAdvancedPerformanceSummary(performance: any[]): any {
  ...
  return {
    ...
    total_parcels_processed: performance.reduce(
      (sum, p) => sum + p.parcels_processed,
      0,
    ),
    total_processing_hours: Math.round(
      times.reduce((sum, t) => sum + t, 0) / 60,
    ),
    average_parcels_per_minute: Math.round(
    ...
    error_rate:
      (
        (errors.reduce((sum, e) => sum + e, 0) /
          performance.reduce((sum, p) => sum + p.parcels_processed, 0)) *
        100
      ).toFixed(3) + "%",
    estimated_total_cost: performance
      .reduce((sum, p) => sum + p.cost_estimate, 0)
      .toFixed(2),
...
function analyzeTrends(stats: any[]): any {
  ...
  const recentAvg =
    recentStats.reduce((sum, s) => sum + (s.parcels_per_minute || 0), 0) /
    recentStats.length;
  const olderAvg =
    olderStats.reduce((sum, s) => sum + (s.parcels_per_minute || 0), 0) /
    olderStats.length;
...
function calculateEstimatedCompletion(log: any): string | null {
  if (!log || log.status !== "processing" || !log.parcels_per_minute)
    return null;
...
function getCountyRecommendations(log: any, countyInfo: any): string[] {
  ...
  if (log.error_count > 10) {
    recommendations.push(
      "High error rate - consider data validation before retry",
    );
  }

  if (log.parcels_per_minute < 300 && log.parcels_per_minute > 0) {
    recommendations.push(
      "Processing speed below average - consider increasing batch size",
    );
  }

  if (log.processed_parcels < countyInfo?.parcels_estimate * 0.9) {
    recommendations.push(
      "Parcel count below estimate - verify data completeness",
    );
  }
