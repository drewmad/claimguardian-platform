    ...
    case "explain":
      return {
        ...
        explanation: {
          ...
          textExplanation:
            "The model prediction is primarily influenced by property age and flood zone classification.",
          confidence: 0.87,
        },
      };
            ...
            driftScore < 0.1
              ...
              : driftScore < 0.2
                ...
                : driftScore < 0.3
                  ...
                  : "high",
          recommendation:
            driftScore < 0.2 ? "Continue monitoring" : "Consider retraining",
          affectedFeatures:
            driftScore > 0.2 ? ["property_value", "weather_patterns"] : [],
        },
      };
...
Deno.test(
  "ML Model Management - Invalid Deployment (Missing Fields)",
  async () => {
    const request = {
      action: "deploy",
      data: {
