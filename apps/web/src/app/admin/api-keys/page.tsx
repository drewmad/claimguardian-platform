...
export default function AdminAPIKeysPage() {
  ...
  const handleUpdateTierLimits = async () => {
    try {
      const result = await adminUpdateTierLimits(
        selectedTier,
        endpointPattern,
        {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-2">
            Manage API keys, rate limits, and usage analytics
          </p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">
                    {analytics.rate_limit_violations}
                  </p>
                </div>
              </div>
            </CardContent>
                      ...
                      <TableCell className="text-gray-300">
                        <div>
                          ...
                          <div className="text-sm text-gray-400">
                            {key.user_profiles.email}
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <Badge
                          className={getTierBadgeColor(key.user_profiles.tier)}
                        >
              ...
              {analytics?.rate_limit_violations_by_user.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400">
                    No rate limit violations in the selected period
                  </p>
                </div>
              ) : (
                <Table>
                  ...
                  <TableBody>
                    {analytics?.rate_limit_violations_by_user.map(
                      (violation, index) => (
                        <TableRow key={index}>
                          <TableCell className="text-white">
                            <div>
                              <div className="font-medium">
                                {violation.user_profiles.full_name}
                              </div>
                              <div className="text-sm text-gray-400">
                                {violation.user_profiles.email}
                              </div>
                            </div>
                          </TableCell>
                          <TableCell className="text-gray-300 font-mono">
                          ...
                          <TableCell>
                            <Badge variant="destructive">
                              {violation.limit_exceeded_count}
                            </Badge>
                          </TableCell>
                          <TableCell className="text-gray-300">
