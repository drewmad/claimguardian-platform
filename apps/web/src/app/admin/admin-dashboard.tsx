        ...
        >
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className={liquidGlass.cards.default}>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {stats.mlOperations.avgAccuracy}%
                  </div>
                  <p className="text-xs text-muted-foreground">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className={liquidGlass.cards.default}>
                ...
                <CardContent className="grid grid-cols-2 gap-3">
                  ...
                  <Button
                    className="justify-start"
                    onClick={() => setActiveTab("claude-learning")}
                  >
          ...
          <TabsContent value="ai-models" className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-400">
                  Configure and monitor AI models across all features
                </p>
              </div>
              <div className="flex gap-3">
                <Button>
            ...
            <Card className={liquidGlass.cards.default}>
              <CardHeader>
                ...
                <CardDescription>
                  Current AI model assignments for each feature
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card className={liquidGlass.cards.default}>
              <CardHeader>
                ...
                <CardDescription>
                  Performance comparison across all AI providers
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
          ...
          <TabsContent value="ml-operations" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className={liquidGlass.cards.default}>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {stats.mlOperations.modelsDeployed}
                  </div>
              ...
              <Card className={liquidGlass.cards.default}>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {stats.mlOperations.totalPredictions.toLocaleString()}
                  </div>
                  <p className="text-xs text-muted-foreground">Last 30 days</p>
                </CardContent>
              </Card>
              ...
              <Card className={liquidGlass.cards.default}>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {stats.mlOperations.lastTraining}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Scheduled weekly
                  </p>
                  ...
                  {recentErrors.map((error) => (
                    <div key={error.id} className="p-4 bg-slate-800 rounded-lg">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          {error.count > 1 && <Badge>×{error.count}</Badge>}
          ...
          <TabsContent value="compliance" className="space-y-6">
            <div>
              ...
              <p className="text-gray-400">
                Florida insurance compliance and user consent tracking
              </p>
            </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    id="adminEmail"
                    type="email"
                    defaultValue="admin@claimguardian.com"
                    className="mt-1 bg-slate-800 border-slate-700"
                  />
                </div>
                <div>
