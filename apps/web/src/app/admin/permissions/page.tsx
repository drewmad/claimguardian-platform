...
export default function PermissionsManagementPage() {
  ...
  const [tierPermissions, setTierPermissions] = useState<
  ...
  const handleSavePermissions = async () => {
    ...
    try {
      ...
      const result = await updateTierPermissions(
        selectedTier,
        permissionsToSave,
      );
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Configure permissions for each subscription tier
          </p>
        </div>
            ...
            {selectedTier ? (
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-white">
                        {tiers.find((t) => t.id === selectedTier)?.display_name}{" "}
                        Permissions
                      </CardTitle>
                      <p className="text-sm text-gray-400 mt-1">
                        Select which features and tools are available for this
                        tier
                      </p>
                    </div>
                    <Button
                            ...
                            {categoryPermissions.map((permission) => (
                              ...
                              >
                                <div className="flex items-center gap-3 flex-1">
                                  <Switch
                                    checked={
                                      tierPermissions[permission.id] || false
                                    }
                                    onCheckedChange={() =>
                                  ...
                                  permission.action === "create" && (
                                    <div className="flex items-center gap-2 ml-3">
                                      ...
                                      <Input
                                        type="number"
                                        value={
                                          permissionLimits[permission.id] || ""
                                        }
                                        onChange={(e) =>
                                          handleLimitChange(
                                            permission.id,
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-gray-400">
                    Select a tier to configure permissions
                  </p>
                </CardContent>
              </Card>
            )}
