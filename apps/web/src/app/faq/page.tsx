...
export const metadata: Metadata = {
  ...
  description:
    "Get answers to common questions about ClaimGuardian AI-powered insurance claim assistance",
};
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-slate-300">
            Get answers to common questions about ClaimGuardian and our
            AI-powered insurance claim assistance.
          </p>
        </div>
        ...
        <div className="space-y-12">
          {faqs.map((section, sectionIndex) => (
            <div
              key={sectionIndex}
              className="bg-slate-800/50 rounded-lg border border-slate-700 p-8"
            >
              ...
              <div className="space-y-6">
                {section.questions.map((faq, faqIndex) => (
                  <div
                    key={faqIndex}
                    className="border-b border-slate-700 last:border-b-0 pb-6 last:pb-0"
                  >
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20 rounded-lg p-8 text-center">
          ...
          <p className="text-slate-300 mb-6">
            Our support team is here to help you navigate your insurance claim
            successfully.
          </p>
