        ...
        <div className="bg-slate-800 rounded-lg shadow-xl p-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm max-w-md mx-auto">
              We've updated our legal documents. Please review and accept the
              new versions to continue using your account.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-300/80">
                  Your continued use of ClaimGuardian requires acceptance of
                  updated legal documents. These changes may include important
                  updates to your rights and our services.
                </p>
              </div>
            </div>
          </div>
