  ...
  const [posts] = useState<CommunityPost[]>([
    {
      ...
      content:
        "Large oak tree fell during last night's storm. Blocking part of Oak Street near 123. City crews have been notified.",
    ...
    },
    {
      ...
      content:
        "Just had my roof repaired by Elite Roofing after the hurricane. Professional, fair pricing, and warranty included. Highly recommend!",
      timestamp: "1 day ago",
      likes: 8,
      replies: 3,
      hasLiked: true,
    ...
    },
    {
      ...
      content:
        "With season starting, here's my checklist: trim trees, clean gutters, secure outdoor items, stock supplies, review insurance. What am I missing?",
  ...
  const [alerts] = useState<NeighborhoodAlert[]>([
    {
      ...
      description:
        "Tropical Storm Warning issued for our area. Expected to arrive Thursday evening.",
      severity: "high",
    ...
    },
    {
      ...
      description:
        "Scheduled water main maintenance Tuesday 9AM-3PM. Water pressure may be affected.",
      severity: "medium",
    ...
    },
    {
      ...
      description:
        "Multiple reports of package thefts in the area. Consider using package lockboxes.",
      severity: "medium",
      timestamp: "1 day ago",
      affectedHomes: 15,
    },
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <p className="text-gray-400">
                Connect with neighbors and local resources
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                {alerts.map((alert) => (
                  <Card
                    key={alert.id}
                    className={`border ${getAlertSeverityColor(alert.severity)}`}
                  >
                              ...
                              <div className="flex items-center gap-4 mt-2 text-xs text-gray-400">
                                ...
                                {alert.affectedHomes && (
                                  <>
                                    <span>•</span>
                                    <span>
                                      {alert.affectedHomes} homes affected
                                    </span>
                                  </>
                                )}
                              </div>
                              ...
                              <div className="flex items-start justify-between mb-2">
                                <div>
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <Icon
                                      className={`w-4 h-4 ${getCategoryColor(post.category)}`}
                                    />
                                    <Badge
                                      variant="outline"
                                      className="text-xs"
