...
function ContractorsDashboardContent() {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<ContractorCategory>("all");
  ...
  const categories = [
    { id: "all", label: "All", count: contractors.length },
    {
      id: "hvac",
      label: "HVAC",
      count: contractors.filter((c) => c.category === "hvac").length,
    },
    {
      id: "plumbing",
      label: "Plumbing",
      count: contractors.filter((c) => c.category === "plumbing").length,
    },
    {
      id: "electrical",
      label: "Electrical",
      count: contractors.filter((c) => c.category === "electrical").length,
    },
    {
      id: "roofing",
      label: "Roofing",
      count: contractors.filter((c) => c.category === "roofing").length,
    },
    {
      id: "general",
      label: "General",
      count: contractors.filter((c) => c.category === "general").length,
    },
    {
      id: "landscaping",
      label: "Landscaping",
      count: contractors.filter((c) => c.category === "landscaping").length,
    },
    {
      id: "cleaning",
      label: "Cleaning",
      count: contractors.filter((c) => c.category === "cleaning").length,
    },
  ];
          ...
          <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
            {categories.map((category) => (
              <button
                key={category.id}
                onClick={() =>
                  setSelectedCategory(category.id as ContractorCategory)
                }
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-white font-medium">
                            ${contractor.totalSpent.toLocaleString()}
                          </p>
                        </div>
                        <div>
