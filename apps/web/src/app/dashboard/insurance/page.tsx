...
import {
  ...
  PolicyStatusBadge,
  InsurabilityBadge,
} from "@/components/ui/insurance-badges";
...
import {
  SearchFilterBar,
  type InsuranceFilterOptions,
} from "@/components/insurance/search-filter-bar";
...
function InsuranceDashboardContent() {
  ...
  const totalCoverage = policies.reduce(
    (sum, policy) => sum + policy.coverage,
    0,
  );
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-300 mb-6">
                ...
                offering luxurious living with breathtaking views and
                state-of-the-art amenities. This property boasts an open floor
                plan, gourmet kitchen, and a spacious master suite. The exterior
                features a beautifully landscaped yard with a private pool and
                patio area, perfect for entertaining. Close to shopping, dining,
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      ...
                      {(selectedProperty.lotSize / 43560).toFixed(2)} acres)
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      {selectedProperty.bathrooms} Full, 1 Half
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-700">
                        ...
                        <div>
                          ...
                          <p className="text-lg text-white">
                            {selectedProperty.propertyTaxes
                              ? formatCurrency(selectedProperty.propertyTaxes)
                              : "N/A"}
                          </p>
                        </div>
                      </div>
                      {selectedProperty.hoaFees && (
                        <div className="mt-4">
                          ...
                          <p className="text-lg text-white">
                            ${selectedProperty.hoaFees} / monthly
                          </p>
                        </div>
                      )}
                    </div>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          >
            <div>
              ...
              <p className="text-gray-400">
                An overview of all your insurance policies and coverage.
              </p>
            </div>
            <motion.button
          ...
          <motion.div variants={fadeInUp}>
            <SearchFilterBar
              ...
              availableCarriers={Array.from(
                new Set(policies.map((p) => p.carrier)),
              )}
              availablePolicyTypes={Array.from(
                new Set(policies.map((p) => p.type)),
              )}
              className="mb-8"
            />
          </motion.div>
                              ...
                              <CardContent className="p-6 space-y-4 border-t border-gray-700/50">
                                ...
                                >
                                  {propertyPolicies.map((policy) => {
                                    const Icon = getPolicyIcon(policy.type);
                                    const isWindstorm =
                                      policy.type.toLowerCase() === "windstorm";
                                    ...
                                    return (
                                      ...
                                      >
                                        <div
                                          ...
                                          onClick={() =>
                                            router.push(
                                              `/dashboard/insurance/policy/${policy.id}`,
                                            )
                                          }
                                        >
