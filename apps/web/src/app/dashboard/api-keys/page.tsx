...
import { createAPIKey, listAPIKeys, revokeAPIKey, getAPIUsageStats } from '@/actions/api-keys'
...
const AVAILABLE_PERMISSIONS = [
  { id: 'properties.read', label: 'Read Properties', description: 'View property information' },
  { id: 'properties.write', label: 'Write Properties', description: 'Create and update properties' },
  { id: 'claims.read', label: 'Read Claims', description: 'View claim information' },
  { id: 'claims.write', label: 'Write Claims', description: 'Create and update claims' },
  { id: 'documentation.read', label: 'Read Documentation', description: 'View field documentation' },
  { id: 'documentation.write', label: 'Write Documentation', description: 'Create field documentation' },
  { id: 'ai.read', label: 'AI Read Access', description: 'Access AI analysis results' },
  { id: 'ai.write', label: 'AI Write Access', description: 'Trigger AI analysis' }
]
...
export default function APIKeysPage() {
  ...
  const [newKeyResult, setNewKeyResult] = useState<{ apiKey: APIKey; plainTextKey: string } | null>(null)
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Select the permissions this API key should have. Leave empty for full access.
                  </p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">{Math.round(stats.avg_response_time)}ms</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">{stats.failed_requests}</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <TableBody>
                {apiKeys.map((key) => (
                  <TableRow key={key.id}>
                    ...
                    <TableCell className="text-gray-300">{formatDate(key.created_at)}</TableCell>
                    <TableCell>
                      {key.is_active && (
                        <Button
                          variant="outline"
