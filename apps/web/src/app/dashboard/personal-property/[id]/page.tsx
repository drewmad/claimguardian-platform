                  ...
                  {!isEditing ? (
                    <>
                      ...
                      <div>
                        ...
                        <div
                          className={`flex items-center gap-1 text-sm ${valueChange >= 0 ? "text-green-400" : "text-red-400"}`}
                        >
                          {valueChange >= 0 ? (
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    {!isEditing ? (
                      <Badge
                        className={
                          item.insured ? "bg-green-600" : "bg-gray-600"
                        }
                      >
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent className="space-y-2">
                  ...
                  <Button
                    ...
                    className="w-full justify-start gap-2"
                    onClick={() =>
                      toast.info("Insurance claim feature coming soon!")
                    }
                  >
