          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <p className="text-gray-400">
                Your complete home inventory management system
              </p>
            </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={`text-xs mt-1 ${valueChange >= 0 ? "text-green-400" : "text-red-400"}`}
                    >
                      {valueChange >= 0 ? "+" : ""}$
                      {Math.abs(valueChange).toLocaleString()}{" "}
                      {valueChange >= 0 ? "appreciation" : "depreciation"}
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-sm text-gray-300">
                        Added "Kitchen Aid Stand Mixer" to Kitchen
                      </p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    {CATEGORIES.slice(0, 10).map((category) => {
                      ...
                      return (
                        ...
                        >
                          <Icon
                            className={`h-8 w-8 mx-auto mb-2 text-${category.color}-400 group-hover:scale-110 transition-transform`}
                          />
                      ...
                      <Card
                        ...
                        onClick={() => {
                          if (isSelectionMode) {
                            ...
                            router.push(
                              `/dashboard/personal-property/${item.id}`,
                            );
                          }
                        }}
                      >
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-2 bg-${categoryColor}-600/20 rounded-lg`}
                              >
                                <Icon
                                  className={`h-5 w-5 text-${categoryColor}-400`}
                                />
                              </div>
                              <div>
                                <h3 className="font-semibold text-white">
                            ...
                            {item.condition && (
                              <Star
                                className={`h-4 w-4 ${getConditionColor(item.condition)}`}
                              />
                            )}
                          </div>
                    ...
                    >
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          <div>
                            <p className="text-2xl font-bold text-white">
                              ${room.totalValue.toLocaleString()}
                            </p>
                            <p className="text-sm text-gray-400">Total value</p>
                          </div>
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="text-center">
                          <div
                            className={`p-4 bg-${category.color}-600/20 rounded-lg inline-flex mb-4`}
                          >
                            <Icon
                              className={`h-8 w-8 text-${category.color}-400`}
                            />
                          </div>
                  ...
                  {items.filter((item) => item.images.length > 0).length ===
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 text-sm mt-2">
                        Add photos to your items to see them here
                      </p>
                      <Button
                        onClick={() => {
                          setCurrentTab("items");
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {CATEGORIES.map((category) => {
                        const categoryItems = itemsWithDepreciation.filter(
                          (item) => item.category === category.id,
                        );
                        const categoryValue = categoryItems.reduce(
                          (sum, item) => sum + item.currentValue,
                        ...
                        const categoryPurchaseValue = categoryItems.reduce(
                          (sum, item) => sum + item.purchasePrice,
                          0,
                        );
                        const depreciationAmount =
                          categoryPurchaseValue - categoryValue;
                        const currentTotalValue = itemsWithDepreciation.reduce(
                          (sum, item) => sum + item.currentValue,
                          0,
                        );
                        const percentage =
                          (categoryValue / currentTotalValue) * 100;
                            ...
                            <div className="flex items-center justify-between mb-1">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {depreciationAmount !== 0 && (
                                  <span
                                    className={`text-xs ${depreciationAmount > 0 ? "text-red-400" : "text-green-400"}`}
                                  >
                                    {depreciationAmount > 0 ? "-" : "+"}$
                                    {Math.abs(
                                      depreciationAmount,
                      ...
                      <div className="flex items-center justify-between p-4 bg-green-900/20 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-400">
                              {insuredItems} of {totalItems} items
                            </p>
                          </div>
                        </div>
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="p-4 bg-yellow-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-gray-300">
                      {allAlerts.filter((a) => a.type === "maintenance").length}{" "}
                      items need maintenance soon
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-red-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-gray-300">
                      {allAlerts.filter((a) => a.type === "replacement").length}{" "}
                      items may need replacement
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {[...itemsWithDepreciation]
                      ...
                      .map((item) => {
                        const Icon = getCategoryIcon(item.category);
                        const depreciationPercent = item.depreciationData
                          ? item.depreciationData.depreciationPercent
                          : 0;
                        return (
                          <div
                            key={item.id}
                          ...
                          >
                            ...
                            <div className="text-right">
                              ...
                              <div className="flex items-center gap-2">
                                {item.insured ? (
                                  <Badge className="text-xs bg-green-600/20 text-green-300">
                                    Insured
                                  </Badge>
                                ) : (
                                  <Badge className="text-xs bg-orange-600/20 text-orange-300">
                                    Not Insured
                                  </Badge>
                                )}
                                <Badge
                                  className={`text-xs ${depreciationPercent > 0 ? "bg-red-600/20 text-red-300" : "bg-green-600/20 text-green-300"}`}
                                >
                                  {depreciationPercent > 0 ? "-" : "+"}
                                  {Math.abs(depreciationPercent)}%
                                </Badge>
                              </div>
                            </div>
                          </div>
        ...
        <Dialog open={showAddModal} onOpenChange={setShowAddModal}>
          <DialogContent className="bg-gray-800 border-gray-700 max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6 mt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="itemName" className="text-gray-400">
                    Item Name *
                  </Label>
                  <Input
                    id="itemName"
                ...
                <div>
                  <Label htmlFor="serialNumber" className="text-gray-400">
                    Serial Number
                  </Label>
                  <Input
                    id="serialNumber"
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="purchasePrice" className="text-gray-400">
                    Purchase Price *
                  </Label>
                  <div className="relative">
                ...
                <div>
                  <Label htmlFor="currentValue" className="text-gray-400">
                    Current Value
                  </Label>
                  <div className="relative">
                    <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
                ...
                <div>
                  <Label htmlFor="purchaseDate" className="text-gray-400">
                    Purchase Date
                  </Label>
                  <Input
                    id="purchaseDate"
              ...
              <div className="bg-gray-700/50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="warrantyExpires" className="text-gray-400">
                      Warranty Expires
                    </Label>
                    <Input
                      id="warrantyExpires"
              ...
              <div className="flex items-center gap-3 p-3 bg-blue-900/20 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-400">
                    Scan product barcode to auto-fill item details
                  </p>
                </div>
                <Button
                  variant="outline"
