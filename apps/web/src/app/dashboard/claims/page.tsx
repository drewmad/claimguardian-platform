...
function ClaimsDashboardContent() {
  ...
  const activeClaims = claims.filter((c) =>
    ["submitted", "investigating", "approved"].includes(c.status),
  ).length;
  const totalEstimated = claims.reduce(
    (sum, claim) => sum + claim.estimatedAmount,
    0,
  );
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-start gap-4">
                          <div
                            className={`w-12 h-12 rounded-lg flex items-center justify-center ${getStatusColor(claim.status)}`}
                          >
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex gap-4">
                          <button
                            onClick={() =>
                              router.push(
                                `/dashboard/claims/${claim.id}/evidence`,
                              )
                            }
                          ...
                          <button
                            onClick={() =>
                              toast.info(
                                "Messages feature coming soon! You'll be able to communicate with your adjuster directly.",
                              )
                            }
                            className="flex items-center gap-2 text-sm text-gray-400 hover:text-white"
                          >
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() =>
                      toast.info(
                        "Document upload feature coming soon! You can upload documents when viewing individual claims.",
                      )
                    }
                    className="w-full text-left p-4 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors flex items-center justify-between"
                  >
                  ...
                  <button
                    onClick={() =>
                      toast.info(
                        "Export feature coming soon! You'll be able to download your claims history in PDF and CSV formats.",
                      )
                    }
                    className="w-full text-left p-4 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors flex items-center justify-between"
                  >
