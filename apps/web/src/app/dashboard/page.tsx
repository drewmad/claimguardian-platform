...
function DashboardContent() {
  ...
  const userName = userProfile?.firstName || user?.user_metadata?.firstName || 'Property Owner'
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4">
                  ...
                  <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700/60 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_rgba(59,130,246,0.15)] transition-all duration-300 hover:bg-gray-800/90 active:scale-95 cursor-pointer">
                    <CardContent className="p-4 sm:p-6">
                      <div className="flex items-center justify-between mb-2">
                        <Home className="h-6 w-6 sm:h-7 sm:w-7 text-blue-400 drop-shadow-[0_2px_8px_rgba(59,130,246,0.3)]" aria-hidden="true" />
                      ...
                      <p className="text-sm text-text-secondary">Property Value</p>
                      <div className="flex items-center gap-1 mt-2">
                        <ArrowUpRight className="h-3 w-3 text-green-400" aria-hidden="true" />
                ...
                >
                  <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700/60 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_rgba(147,51,234,0.15)] transition-all duration-300 hover:bg-gray-800/90 active:scale-95 cursor-pointer">
                    <CardContent className="p-4 sm:p-6">
                      <div className="flex items-center justify-between mb-2">
                        <Package className="h-6 w-6 sm:h-7 sm:w-7 text-purple-400 drop-shadow-[0_2px_8px_rgba(147,51,234,0.3)]" aria-hidden="true" />
                      ...
                      <p className="text-sm text-text-secondary">Items Tracked</p>
                ...
                <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700/60 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_rgba(6,182,212,0.15)] transition-all duration-300 hover:bg-gray-800/90 active:scale-95 cursor-pointer touch-target">
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center justify-between mb-2">
                      <Shield className="h-6 w-6 sm:h-7 sm:w-7 text-cyan-400 drop-shadow-[0_2px_8px_rgba(6,182,212,0.3)]" aria-hidden="true" />
                    ...
                    <Progress value={100} className="h-1 mt-2" aria-label="Coverage progress 100%" />
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700/60 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_rgba(34,197,94,0.15)] transition-all duration-300 hover:bg-gray-800/90 active:scale-95 cursor-pointer touch-target">
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center justify-between mb-2">
                      <Receipt className="h-6 w-6 sm:h-7 sm:w-7 text-green-400 drop-shadow-[0_2px_8px_rgba(34,197,94,0.3)]" aria-hidden="true" />
                    ...
                    <div className="flex items-center gap-1 mt-2">
                      <ArrowDownRight className="h-3 w-3 text-green-400" aria-hidden="true" />
                ...
                >
                  <Card className="bg-gray-800/80 backdrop-blur-sm border-gray-700/60 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_rgba(251,146,60,0.15)] transition-all duration-300 hover:bg-gray-800/90 active:scale-95 cursor-pointer">
                    <CardContent className="p-4 sm:p-6">
                      <div className="flex items-center justify-between mb-2">
                        <AlertCircle className="h-6 w-6 sm:h-7 sm:w-7 text-orange-400 drop-shadow-[0_2px_8px_rgba(251,146,60,0.3)]" aria-hidden="true" />
                        <span className={`text-xs ${hasPendingTasks ? 'text-orange-400 animate-pulse' : 'text-green-400'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                ...
                <Card className="bg-gray-800/85 backdrop-blur-md border-gray-700/60 shadow-[0_16px_40px_rgba(0,0,0,0.4)] hover:shadow-[0_16px_40px_rgba(6,182,212,0.1)] transition-all duration-500">
                  ...
                  <CardContent>
                    <section role="region" aria-label="Weather alerts and conditions">
                      ...
                      <div className="p-4 bg-orange-900/25 backdrop-blur-sm border border-orange-500/40 rounded-lg shadow-[0_8px_24px_rgba(251,146,60,0.15)] mb-4">
                        <div className="flex items-start gap-3">
                          <div className="p-2 bg-orange-600/25 backdrop-blur-sm rounded-lg shadow-[0_4px_12px_rgba(251,146,60,0.2)]">
                            <Wind className="h-5 w-5 text-orange-400 drop-shadow-[0_2px_6px_rgba(251,146,60,0.4)]" aria-hidden="true" />
                          </div>
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-1">
                              <h3 className="font-semibold text-orange-300">Hurricane Watch - Category 2</h3>
                              <Badge className="bg-orange-600/20 text-orange-400 border-orange-600/30 text-xs">
                                72hrs away
                              </Badge>
                            </div>
                            <p className="text-sm text-text-secondary mb-2">Tropical Storm Maria strengthening in Gulf</p>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div className="bg-gray-700/60 backdrop-blur-sm rounded-lg p-3 shadow-[0_4px_16px_rgba(0,0,0,0.2)] hover:bg-gray-700/70 transition-all duration-300">
                          <div className="flex items-center gap-2 mb-1">
                            <Thermometer className="h-4 w-4 text-red-400 drop-shadow-[0_2px_4px_rgba(239,68,68,0.3)]" aria-hidden="true" />
                        ...
                        <div className="bg-gray-700/60 backdrop-blur-sm rounded-lg p-3 shadow-[0_4px_16px_rgba(0,0,0,0.2)] hover:bg-gray-700/70 transition-all duration-300">
                          <div className="flex items-center gap-2 mb-1">
                            <Droplets className="h-4 w-4 text-blue-400 drop-shadow-[0_2px_4px_rgba(59,130,246,0.3)]" aria-hidden="true" />
                        ...
                        <div className="bg-gray-700/60 backdrop-blur-sm rounded-lg p-3 shadow-[0_4px_16px_rgba(0,0,0,0.2)] hover:bg-gray-700/70 transition-all duration-300">
                          <div className="flex items-center gap-2 mb-1">
                            <Wind className="h-4 w-4 text-gray-400 drop-shadow-[0_2px_4px_rgba(156,163,175,0.3)]" aria-hidden="true" />
                            <span className="text-sm text-text-secondary">Wind</span>
                          </div>
                      ...
                      <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-text-secondary">Last serviced 2 weeks ago</p>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-text-secondary">Inspection due in 30 days</p>
                          </div>
                        </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <Card className="bg-gray-800/85 backdrop-blur-md border-gray-700/60 shadow-[0_16px_40px_rgba(0,0,0,0.4)] hover:shadow-[0_16px_40px_rgba(59,130,246,0.1)] transition-all duration-500">
                  <CardHeader>
                    <CardTitle className="text-white flex items-center gap-2">
                      <Activity className="h-5 w-5 text-blue-400 drop-shadow-[0_2px_8px_rgba(59,130,246,0.4)]" aria-hidden="true" />
                      Recent Activity
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    {hasRecentActivity ? (
                      <div className="space-y-3" role="log" aria-label="Recent activity timeline">
                        {/* Activity items with better mobile styling */}
                        <div className="flex items-start gap-3">
                          <div className="relative">
                            <div className="w-8 h-8 bg-green-600/20 rounded-full flex items-center justify-center">
                              <Plus className="h-4 w-4 text-green-400" aria-hidden="true" />
                            </div>
                          ...
                          <div className="flex-1 -mt-0.5">
                            ...
                            <p className="text-xs text-text-secondary">Kitchen appliances - $2,400</p>
                            <time className="text-xs text-gray-500 mt-1 block">2 hours ago</time>
                          </div>
                        </div>
                        {/* More activity items... */}
                      </div>
                ...
                {/* Upcoming Tasks */}
                <Card id="upcoming-tasks" className="bg-gray-800/85 backdrop-blur-md border-gray-700/60 shadow-[0_16px_40px_rgba(0,0,0,0.4)] hover:shadow-[0_16px_40px_rgba(251,146,60,0.1)] transition-all duration-500" tabIndex={-1}>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                  ...
                  <CardContent>
                    {hasPendingTasks ? (
                      <div className="space-y-3" role="region" aria-label="Pending tasks">
                        <div className="p-3 bg-orange-900/25 backdrop-blur-sm border border-orange-600/40 rounded-lg shadow-[0_4px_16px_rgba(251,146,60,0.15)]">
                          <div className="flex items-start justify-between mb-2">
                            <div>
                              <h4 className="text-sm font-medium text-white">Prepare for Hurricane</h4>
                              <p className="text-xs text-text-secondary mt-1">Review checklist and secure property</p>
                            </div>
                            <Badge className="bg-red-600/25 backdrop-blur-sm text-red-400 text-xs border-red-600/40 shrink-0 ml-2">Urgent</Badge>
                          </div>
                          <div className="flex items-center gap-3">
                            ...
                            <Button size="sm" className="h-6 px-2 text-xs bg-orange-600 hover:bg-orange-700 touch-target">
                              Start
                            </Button>
                          </div>
                        </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 bg-blue-600/25 backdrop-blur-sm rounded-lg shadow-[0_4px_12px_rgba(59,130,246,0.3)]">
                        <Zap className="h-5 w-5 text-blue-400 drop-shadow-[0_2px_8px_rgba(59,130,246,0.5)]" aria-hidden="true" />
                      </div>
