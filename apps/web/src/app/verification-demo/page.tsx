...
export default function VerificationDemoPage() {
  ...
  const mockUser = {
    ...
    email_confirmed_at: demoState.userVerified
  ...
  const demoComponents = [
    {
      ...
      demo: (
        <div className="space-y-4">
          <Button
            onClick={() =>
              setDemoState((prev) => ({ ...prev, showWizard: true }))
            }
          ...
          {demoState.showWizard && (
            ...
            >
              <EmailVerificationWizard
                ...
                onCancel={() =>
                  setDemoState((prev) => ({ ...prev, showWizard: false }))
                }
                showSkipOption={true}
              />
            </motion.div>
    ...
    },
    {
      ...
      description:
        "Contextual banner for unverified users with resend functionality",
      icon: AlertTriangle,
      color: "bg-orange-600",
      demo: (
        <div className="space-y-4">
          <div className="flex gap-2">
            <Button
              size="sm"
              variant={
                demoState.bannerVariant === "default" ? "default" : "outline"
              }
              onClick={() =>
                setDemoState((prev) => ({
                  ...prev,
            ...
            <Button
              size="sm"
              variant={
                demoState.bannerVariant === "compact" ? "default" : "outline"
              }
              onClick={() =>
                setDemoState((prev) => ({
                  ...prev,
            ...
            <Button
              size="sm"
              variant={
                demoState.bannerVariant === "inline" ? "default" : "outline"
              }
              onClick={() =>
                setDemoState((prev) => ({
                  ...prev,
          ...
          {demoState.showBanner && !demoState.userVerified && (
            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              ...
              <VerificationBanner
                ...
                onVerified={() =>
                  setDemoState((prev) => ({ ...prev, userVerified: true }))
                }
              />
            </div>
          )}
        ...
        <div className="space-y-4">
          <div className="flex gap-2">
            <Button
              size="sm"
              onClick={() =>
                setDemoState((prev) => ({ ...prev, userVerified: false }))
              }
            >
              Unverified User
            </Button>
        ...
        <div className="space-y-4">
          ...
          {demoState.showSuccess && (
            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              <VerificationSuccessBanner
                onDismiss={() =>
                  setDemoState((prev) => ({ ...prev, showSuccess: false }))
                }
              />
            </div>
          )}
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Comprehensive demonstration of ClaimGuardian's enhanced email
            verification system with improved UX, toast notifications, and
          ...
          <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
            <CardHeader>
              ...
              <p className="text-gray-300">
                Try out each component to see the enhanced email verification
                experience
              </p>
            </CardHeader>
            <CardContent>
                    ...
                    <Card>
                      <CardHeader>
                        <div className="flex items-center space-x-3">
                          <div
                            className={`w-10 h-10 rounded-lg ${component.color} flex items-center justify-center`}
                          >
                      ...
                      <CardContent>{component.demo}</CardContent>
                    </Card>
                  </TabsContent>
                ))}
              </Tabs>
