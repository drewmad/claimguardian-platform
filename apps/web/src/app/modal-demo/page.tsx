...
const features = [
  {
    ...
    description:
      "Optimized for touch interactions with slide-up animations on mobile devices",
  },
  {
    icon: Hand,
    title: "Touch Gestures",
    description:
      "Swipe to close, drag to dismiss, and native touch feel on all interactions",
  },
  {
    icon: Eye,
    title: "Visual Feedback",
    description:
      "Real-time validation, password strength indicators, and smooth transitions",
  },
  {
    icon: Zap,
    title: "Performance",
    description:
      "Framer Motion animations with optimized rendering for smooth 60fps",
  },
  {
    icon: Shield,
    title: "Accessibility",
                ...
                {(["mobile", "tablet", "desktop"] as const).map((device) => {
                  ...
                  return (
                    <Button
                      key={device}
                      variant={
                        selectedDevice === device ? "default" : "outline"
                      }
