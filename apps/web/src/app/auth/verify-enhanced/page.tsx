...
function EnhancedVerifyContent() {
  ...
  const mapSupabaseError = useCallback(
    (error: any, errorCode?: string, errorDescription?: string) => {
  ...
  const verifyEmail = useCallback(async () => {
    try {
      ...
      if (errorParam) {
        const errorInfo = mapSupabaseError(
          errorParam,
          errorCode || undefined,
      ...
      if (!finalTokenHash) {
        ...
        setState((prev) => ({
          ...
          errorDetails: {
            suggestion:
              "Please check that you used the complete verification link from your email",
          },
        }));
        return;
      }
      ...
      if (data.user) {
        ...
        addNotification({
          ...
          message:
            "Your email has been verified. You can now access all features and start managing your property portfolio.",
          type: "success",
          priority: "high",
          source: "system",
          actionable: true,
          ...
          >
            ...
            >
              <CardHeader className="text-center pb-6">
                <div className="mx-auto mb-6">{getStatusIcon()}</div>
                ...
                <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          "mailto:support@claimguardianai.com",
                          "_blank",
                        )
                      }
                      className="flex-1 flex items-center justify-center"
