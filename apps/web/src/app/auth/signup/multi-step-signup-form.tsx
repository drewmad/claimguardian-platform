  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (signUpData?.user) {
        ...
        setError(
          "Signup completed but no user data received. Please try signing in.",
        );
      }
    } catch (err) {
          ...
          <div className="space-y-8">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-400">
                We follow Florida law and safeguard your data with advanced
                security standards.
              </p>
            </div>
              ...
              <AlertDescription className="text-blue-100">
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1 text-sm">
                    <li>
                      • <strong>Duration:</strong> About 2 minutes
                    </li>
                    <li>
                      • <strong>Includes:</strong> Legal disclosures required by
                      Florida law
                    </li>
                  </ul>
                </div>
                ...
                {formData.password && (
                  <div className="mt-2">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span
                        className={`text-xs font-medium ${getPasswordStrength(formData.password).color}`}
                      >
                    ...
                    {getPasswordStrength(formData.password).feedback.length >
                      0 && (
                      <p className="text-xs text-gray-400">
                        Add:{" "}
                        {getPasswordStrength(formData.password).feedback.join(
                          ", ",
                        )}
                      </p>
                    )}
            ...
            <div className="border-t border-slate-700 pt-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  type="button"
                  onClick={() =>
                    updateFormData("residencyType", "real_estate_pro")
                  }
                  className={cn(
                    "p-3 rounded-lg border text-sm font-medium transition-all",
            ...
            <div className="bg-slate-800/50 rounded-lg p-6 space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked: boolean) =>
                    updateFormData("legalAgreements", !!checked)
                  }
                  className="mt-1"
                />
              ...
              <p className="text-xs text-gray-500 ml-7">
                By accepting, you agree to our terms of use and how we handle
                your data
              </p>
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-400 mt-1">
                Important information about our AI tools
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-6 space-y-4">
              <div className="bg-amber-950/30 border border-amber-800/50 rounded-lg p-4 mb-4">
                <p className="text-sm text-amber-200">
                  ClaimGuardian uses artificial intelligence to help analyze
                  documents, provide suggestions, and guide you through the
                  claims process. While our AI is designed to be helpful and
                  accurate, it's important to understand its limitations.
                </p>
              </div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-start gap-2">
                  ...
                  AI can make mistakes and may occasionally provide incorrect
                  information
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 mt-0.5">•</span>
                  Always verify important information with your insurance
                  company or legal advisor
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 mt-0.5">•</span>
              ...
              <div className="flex items-start space-x-3 pt-4 border-t border-slate-700">
                <Checkbox
                  ...
                  onCheckedChange={(checked: boolean) =>
                    updateFormData("aiDisclaimerAccepted", !!checked)
                  }
                  className="mt-1"
                />
                <Label
                ...
                >
                  I understand that AI can make mistakes and I should verify
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Look for an email from ClaimGuardian with the subject
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between text-sm text-gray-400 mb-2">
              <span>
                Step {stepProgress.currentStep} of {stepProgress.totalSteps}
              </span>
            ...
            <div className="flex justify-between mt-2">
              {["Welcome", "Account", "Legal", "AI Terms", "Success"].map(
                (stepName, index) => {
