...
export const metadata: Metadata = {
  ...
  description: 'Live claims monitoring, queue management, and automated processing with AI-powered insights',
}
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto p-6 max-w-7xl">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-white">Real-Time Claims Processing</h1>
