...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered policy analysis and optimization recommendations to maximize coverage and minimize costs",
};
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto p-6 max-w-7xl">
        <SmartRecommendationsDashboard userId={userId} className="space-y-6" />
      </div>
    </DashboardLayout>
  );
}
