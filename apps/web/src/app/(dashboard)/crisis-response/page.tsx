...
export const metadata: Metadata = {
  ...
  description:
    "Emergency response coordination and crisis management system with real-time alerts and action plans",
};
      ...
      <div className="container mx-auto p-6 max-w-7xl">
        <div className="mb-6">
          ...
          <p className="text-gray-400 mt-2">
            Emergency detection, response coordination, and crisis management
            system
          </p>
        </div>

        <CrisisResponseDashboard userId={userId} className="space-y-6" />
      </div>
    </DashboardLayout>
  );
}
