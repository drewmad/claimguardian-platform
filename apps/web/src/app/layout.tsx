...
import {
  ToastProvider,
  CustomToaster,
} from "@/components/notifications/toast-system";
...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered property intelligence network that creates a living digital twin of everything you own. Track warranties, optimize maintenance, protect investments, and preserve your legacy. Built by Florida family for Florida families.",
  keywords:
    "property management Florida, AI property intelligence, warranty tracking, digital twin property, Florida hurricane protection, property insurance optimization, generational wealth building, community resilience Florida",
  ...
  openGraph: {
    ...
    title: "ClaimGuardian - Your Property's Complete Story, Protected Forever",
    description:
      "Transform property ownership from anxiety into wealth building. AI-powered platform tracks everything you own, protects your investments, and preserves your legacy with complete privacy control.",
  ...
  twitter: {
    ...
    description:
      "Built by Florida family who survived Hurricane Ian. AI-powered property management that protects your investments and preserves your legacy.",
    creator: "@claimguardian",
  },
  robots: {
    index: true,
                ...
                <QueryProvider>
                  <AuthProvider>
                    ...
                    <div aria-live="polite" aria-atomic="true">
                      <CustomToaster position="top-right" theme="system" />
                    </div>
