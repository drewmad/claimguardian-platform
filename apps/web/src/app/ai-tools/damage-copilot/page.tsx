      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Get real-time AI guidance to capture perfect damage documentation
            photos. Our AI coach ensures you capture all required angles with
            optimal quality.
          </p>
        </div>
        ...
        <div className="bg-gray-800 border-gray-700 rounded-lg p-6">
          <p className="text-gray-400">
            Feature temporarily disabled for deployment.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center gap-2">
                  ...
                  <span>
                    <strong>Overview:</strong> Wide shot showing entire damage
                    area
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span>
                    <strong>Close-up:</strong> Detailed view of specific damage
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span>
                    <strong>Context:</strong> Damage in relation to surroundings
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span>
                    <strong>Comparison:</strong> Undamaged areas for reference
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span>
                    <strong>Evidence:</strong> Serial numbers, measurements
                  </span>
                </li>
              </ul>
            </div>
