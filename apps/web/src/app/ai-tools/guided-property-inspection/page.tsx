...
export default function GuidedPropertyInspectionPage() {
      ...
      areas: [
        {
          ...
          name: 'Roof & Gutters',
          checkpoints: [
            { id: 'r1', item: 'Shingles/Tiles', description: 'Check for missing, damaged, or loose shingles' },
            { id: 'r2', item: 'Flashing', description: 'Inspect around chimneys, vents, and skylights' },
            { id: 'r3', item: 'Gutters', description: 'Check for clogs, damage, or improper drainage' },
            { id: 'r4', item: 'Downspouts', description: 'Ensure proper attachment and drainage away from foundation' }
          ]
        },
        {
          id: 'walls',
          name: 'Walls & Siding',
          checkpoints: [
            { id: 'w1', item: 'Siding', description: 'Look for cracks, gaps, or loose panels' },
            { id: 'w2', item: 'Paint/Stucco', description: 'Check for peeling, cracking, or water damage' },
            { id: 'w3', item: 'Windows', description: 'Inspect frames, seals, and operation' },
            { id: 'w4', item: 'Doors', description: 'Check weatherstripping, operation, and locks' }
          ]
        },
        {
          id: 'foundation',
          ...
          checkpoints: [
            { id: 'f1', item: 'Foundation', description: 'Look for cracks, settling, or water intrusion' },
            { id: 'f2', item: 'Grading', description: 'Ensure proper slope away from foundation' },
            { id: 'f3', item: 'Drainage', description: 'Check for standing water or erosion' }
          ]
        }
      ]
    },
      ...
      areas: [
        {
          ...
          name: 'Appliances',
          checkpoints: [
            { id: 'a1', item: 'Refrigerator', description: 'Check temperature, seals, and ice maker' },
            { id: 'a2', item: 'Stove/Oven', description: 'Test all burners and oven operation' },
            { id: 'a3', item: 'Dishwasher', description: 'Run a cycle and check for leaks' },
            { id: 'a4', item: 'Microwave', description: 'Test operation and ventilation' },
            { id: 'a5', item: 'Garbage Disposal', description: 'Test operation and check for leaks' }
          ]
        },
        {
          id: 'plumbing',
          name: 'Plumbing',
          checkpoints: [
            { id: 'p1', item: 'Sink & Faucet', description: 'Check for leaks and proper drainage' },
            { id: 'p2', item: 'Under Sink', description: 'Inspect for leaks, damage, or mold' },
            { id: 'p3', item: 'Water Pressure', description: 'Test hot and cold water pressure' }
          ]
        },
        {
          id: 'surfaces',
          ...
          checkpoints: [
            { id: 's1', item: 'Countertops', description: 'Check for damage, stains, or separation' },
            { id: 's2', item: 'Cabinets', description: 'Test doors/drawers and check for damage' },
            { id: 's3', item: 'Backsplash', description: 'Look for loose tiles or water damage' }
          ]
        }
      ]
    },
      ...
      areas: [
        {
          ...
          name: 'Fixtures',
          checkpoints: [
            { id: 'b1', item: 'Toilet', description: 'Check for leaks, proper flush, and stability' },
            { id: 'b2', item: 'Sink & Vanity', description: 'Test faucets and check for leaks' },
            { id: 'b3', item: 'Tub/Shower', description: 'Check for proper drainage and leaks' },
            { id: 'b4', item: 'Exhaust Fan', description: 'Test operation and check venting' }
          ]
        },
        {
          id: 'water',
          name: 'Water & Moisture',
          checkpoints: [
            { id: 'm1', item: 'Caulking', description: 'Check around tub, shower, and fixtures' },
            { id: 'm2', item: 'Grout & Tile', description: 'Look for cracks or missing grout' },
            { id: 'm3', item: 'Water Damage', description: 'Check walls, ceiling, and floor for stains' }
          ]
        }
      ]
    },
      ...
      areas: [
        {
          ...
          name: 'HVAC System',
          checkpoints: [
            { id: 'h1', item: 'Air Handler', description: 'Check filter and listen for unusual noises' },
            { id: 'h2', item: 'Thermostat', description: 'Test heating and cooling operation' },
            { id: 'h3', item: 'Vents', description: 'Check airflow and look for blockages' }
          ]
        },
        {
          id: 'electrical',
          name: 'Electrical',
          checkpoints: [
            { id: 'e1', item: 'Panel', description: 'Look for proper labeling and no double-taps' },
            { id: 'e2', item: 'Outlets', description: 'Test GFCI outlets and check for proper grounding' },
            { id: 'e3', item: 'Switches', description: 'Test all switches and dimmers' }
          ]
        }
      ]
    }
  ...
  const handleConditionSelect = (condition: 'good' | 'fair' | 'poor' | 'critical') => {
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-3xl font-bold text-white">Guided Property Inspection</h1>
                <Badge className="bg-blue-600/20 text-blue-400 border-blue-600/30">
                  AI Assisted
                </Badge>
              </div>
              <p className="text-gray-400 max-w-3xl">
                Comprehensive property inspection with AI guidance. Document conditions, identify issues, and generate professional reports.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-6">
                  <Card className="bg-gray-800 border-gray-700">
                    <CardHeader>
                      <CardTitle className="text-white">Inspection Overview</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="bg-gray-700/50 rounded-lg p-4">
                            ...
                            <p className="text-2xl font-bold text-white">45-60 min</p>
                          </div>
                        </div>

                        <div className="space-y-3">
                          <h4 className="text-white font-medium">Areas to Inspect:</h4>
                          {rooms.map((room) => (
                            <div key={room.id} className="p-3 bg-gray-700/50 rounded-lg">
                              <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline" className="text-xs">
                                  {room.areas.reduce((total, area) => total + area.checkpoints.length, 0)} items
                                </Badge>
                              </div>
                            </div>
                          ))}
                ...
                <div className="space-y-6">
                    ...
                    <CardContent>
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          ...
                          <span className="text-gray-300">Flashlight for dark areas</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                          <span className="text-gray-300">Camera or phone for photos</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                          <span className="text-gray-300">Ladder for roof/gutter inspection</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                          <span className="text-gray-300">45-60 minutes of time</span>
                        </li>
                      </ul>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-purple-900/20 border-purple-600/30">
                    <CardHeader>
                      <CardTitle className="text-purple-400 text-lg">AI Features</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2 text-sm">
                        <div className="flex items-start gap-2">
                          <Volume2 className="h-4 w-4 text-purple-400 mt-0.5" />
                          <span className="text-gray-300">Voice-guided instructions</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <Camera className="h-4 w-4 text-purple-400 mt-0.5" />
                          <span className="text-gray-300">Photo analysis for issues</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <FileText className="h-4 w-4 text-purple-400 mt-0.5" />
                          <span className="text-gray-300">Automated report generation</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <Target className="h-4 w-4 text-purple-400 mt-0.5" />
                          <span className="text-gray-300">Priority recommendations</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="bg-gray-800 border-gray-700">
                      ...
                      <CardContent>
                        <div className="space-y-6">
                          ...
                          <div className="space-y-3">
                            <Label className="text-white">Condition Assessment</Label>
                            <div className="grid grid-cols-4 gap-3">
                              ...
                              <button
                                onClick={() => handleConditionSelect('critical')}
                                className={`p-4 rounded-lg border-2 transition-all ${
                          ...
                          {currentCheckpoint?.notes && (
                            <div className="p-3 bg-gray-700/50 rounded-lg">
                              ...
                              <p className="text-white">{currentCheckpoint.notes}</p>
                            </div>
                          )}
                          ...
                          <div className="flex items-center gap-3 pt-4">
                            <Button
                              ...
                              variant="outline"
                              disabled={currentRoomIndex === 0 && currentAreaIndex === 0 && currentCheckpointIndex === 0}
                              className="bg-gray-700 hover:bg-gray-600 border-gray-600"
                            >
                  ...
                  <div className="space-y-6">
                    ...
                    <Card className="bg-gray-800 border-gray-700">
                      <CardHeader>
                        <CardTitle className="text-white">Room Progress</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-3">
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className={`text-sm ${
                                    index === currentRoomIndex ? 'text-white font-medium' : 'text-gray-400'
                                  }`}>
                                    {room.name}
                                  </span>
                                </div>
                    ...
                    <Card className="bg-gray-800 border-gray-700">
                      <CardHeader>
                        <CardTitle className="text-white">Inspection Stats</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-400">Items Inspected</span>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-lg font-semibold text-orange-400">{issueCount}</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-400">Photos Taken</span>
                            <span className="text-lg font-semibold text-white">
                              {rooms.reduce((total, room) => total + room.photos, 0)}
                            </span>
                          </div>
                          <div className="flex items-center justify-between">
