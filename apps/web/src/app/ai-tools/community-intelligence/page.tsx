          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-400 max-w-3xl">
                I know what others in my situation received! Aggregate insights
                from Florida claims with privacy-preserving analytics.
              </p>
            </div>
            ...
            <Alert className="bg-violet-900/20 border-violet-600/30">
              ...
              <AlertDescription className="text-violet-200">
                <div className="flex items-center justify-between">
                  <span>
                    All data is anonymized and aggregated. No personal
                    information is ever shared or exposed.
                  </span>
                  <Button
                    size="sm"
                    variant="ghost"
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
                <div className="text-center">
                  <span className="text-gray-400">
                    Privacy-preserving analytics temporarily disabled for
                    deployment.
                  </span>
                </div>
              </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-300">
                          Share your anonymized claim outcome to help others
                          understand fair settlements. Your privacy is always
                          protected.
                        </p>
                      </div>
                      <Button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                      <div>
                        ...
                        <p className="text-gray-400">
                          All data is anonymized using differential privacy
                          techniques. No personal information, addresses, or
                          identifiable details are ever collected or shared.
                        </p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-gray-200 mb-2">
                        ...
                        <p className="text-gray-400">
                          Insights are generated from real claim outcomes shared
                          by Florida property owners. More data means better
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">
                          Understand trends, fair settlements, and success rates
                          specific to your damage type and location. Make
                          informed decisions.
                        </p>
                      </div>
                    </div>
