...
export default function ProactiveClaimOptimizerPage() {
  ...
  const [optimizationItems, setOptimizationItems] = useState<
    OptimizationItem[]
  >([]);
  const [claimStrength, setClaimStrength] = useState<ClaimStrength | null>(
    null,
  );
  const [successProbability, setSuccessProbability] = useState<number | null>(
    null,
  );
  ...
  const mockOptimizationItems: OptimizationItem[] = [
    {
      ...
      description:
        "No initial damage assessment report found within 72 hours of incident",
    ...
    },
    {
      ...
      description:
        "Only 3 photos provided. Insurance typically requires 10-15 detailed photos",
      impact: "May lead to partial claim denial",
      action:
        "Add wide-angle, close-up, and context photos of all damaged areas",
      completed: false,
    },
    {
      id: "3",
    ...
    },
    {
      ...
      description:
        "No confirmation that damage type is covered under current policy",
    ...
    },
    {
      ...
      description:
        "Current description lacks detail about damage cause and progression",
  ...
  const toggleItemCompletion = (id: string) => {
    ...
    const completedCount =
      optimizationItems.filter((item) =>
        item.id === id
          ? !optimizationItems.find((i) => i.id === id)?.completed
          : item.completed,
      ).length + 1;
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300 max-w-3xl drop-shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
                      It caught issues I never would have noticed!
                      Pre-submission review with claim strength scoring and
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-xl font-semibold text-white mb-2">
                        Ready to Optimize Your Claim?
                      </h3>
                      <p className="text-gray-300">
                        Our AI will analyze your claim documents and identify
                        opportunities to strengthen your case before submission.
                      </p>
                    </div>
                    <Button
                      onClick={runAnalysis}
              ...
              <>
                  ...
                  <Card className="bg-gray-800/70 backdrop-blur-xl border-gray-700/50 shadow-[0_12px_40px_rgba(0,0,0,0.3)] hover:shadow-[0_20px_60px_rgba(59,130,246,0.15)] transition-all duration-500">
                    ...
                    <CardContent>
                      <div className="text-center">
                        <div
                          className={`text-4xl font-bold ${getStrengthColor(claimStrength?.category || "")}`}
                        >
                          {claimStrength?.score}%
                        </div>
                        <Badge
                          className={`mt-2 ${
                            claimStrength?.category === "strong"
                              ? "bg-green-600/20 text-green-400"
                              : claimStrength?.category === "good"
                                ? "bg-blue-600/20 text-blue-400"
                                : claimStrength?.category === "fair"
                      ...
                      <div className="mt-4 space-y-2">
                        {Object.entries(claimStrength?.factors || {}).map(
                          ([key, value]) => (
                            <div key={key}>
                    ...
                    <CardContent>
                      ...
                      <Alert className="mt-4 bg-blue-900/20 border-blue-600/30">
                        ...
                        <AlertDescription className="text-blue-200 text-sm">
                          Complete critical items to increase success rate to
                          85%+
                        </AlertDescription>
                      </Alert>
                    </CardContent>
                    ...
                    <CardContent>
                      <div className="text-center">
                        <div className="text-4xl font-bold text-green-400">
                          {
                            optimizationItems.filter((item) => item.completed)
                              .length
                          }
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  <Button
                    size="sm"
                    variant={
                      selectedCategory === "evidence" ? "default" : "outline"
                    }
                  ...
                  <Button
                    size="sm"
                    variant={
                      selectedCategory === "timeline" ? "default" : "outline"
                    }
                  ...
                  <Button
                    size="sm"
                    variant={
                      selectedCategory === "coverage" ? "default" : "outline"
                    }
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-start justify-between mb-2">
                              <h3
                                className={`text-lg font-semibold ${item.completed ? "text-gray-500 line-through" : "text-white"}`}
                              >
                                {item.title}
                              </h3>
                              <Badge
                            ...
                            <Button
                              ...
                              className={
                                item.completed ? "bg-gray-700" : "bg-blue-600"
                              }
                            >
                              {item.completed
                                ? "Mark as Incomplete"
