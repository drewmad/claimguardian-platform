      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="mb-8">
          ...
          <p className="text-gray-400 max-w-3xl">
            Get instant answers about your insurance policy, coverage details,
            and claim procedures. Our AI specializes in Florida property
            insurance and hurricane-related coverage.
          </p>
        </div>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          className={`text-xs ${lastAbTestInfo.variant === "A" ? "bg-green-600/20 text-green-300 border-green-600/30" : "bg-purple-600/20 text-purple-300 border-purple-600/30"}`}
                        >
                      ...
                      <div>
                        ...
                        <div className="flex gap-1">
                          <Button
                            ...
                            onClick={() =>
                              handleQualityFeedback("helpful", true)
                            }
                          ...
                          <Button
                            ...
                            onClick={() =>
                              handleQualityFeedback("helpful", false)
                            }
                            disabled={feedbackSubmitted}
                        ...
                        <div className="flex gap-1">
                          {[1, 2, 3, 4, 5].map((rating) => (
                            <Button
                              ...
                              variant="ghost"
                              onClick={() =>
                                handleQualityFeedback("accuracy", rating)
                              }
                              disabled={feedbackSubmitted}
            ...
            <div className="mt-4 p-4 bg-amber-900/20 border border-amber-500/30 rounded-lg">
              <div className="flex gap-3">
                ...
                <div className="text-sm text-amber-200">
                  ...
                  <p>
                    This AI assistant provides general information about
                    insurance policies. Always consult your actual policy
                    documents and insurance agent for specific coverage details
