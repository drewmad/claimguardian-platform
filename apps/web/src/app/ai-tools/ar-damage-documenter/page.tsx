...
export default function ARDamageDocumenterPage() {
  ...
  const [currentMode, setCurrentMode] = useState<
    "capture" | "measure" | "annotate" | "ar-notes" | "compare" | "ai-analysis"
  >("capture");
  ...
  const [imageType, setImageType] = useState<"before" | "after" | "progress">(
    "before",
  );
    ...
    if (file) {
      try {
        ...
        reader.onload = (e) => {
          ...
          toast.success(
            `${imageType.charAt(0).toUpperCase() + imageType.slice(1)} image uploaded successfully`,
          );
        };
  ...
  const handleCameraCapture = async (file: File) => {
    try {
      ...
      reader.onload = (e) => {
        ...
        toast.success(
          `${imageType.charAt(0).toUpperCase() + imageType.slice(1)} image captured successfully`,
        );
      };
      reader.readAsDataURL(file);
    } catch (error) {
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300 max-w-3xl drop-shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
                      Professional documentation in minutes! Use WebXR
                      measurement tools with AI validation and 3D visualization.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {!isARSupported && (
              <Alert className="bg-yellow-900/20 border-yellow-600/30">
                ...
                <AlertDescription className="text-yellow-200">
                  AR features are not fully supported on this device. You can
                  still use image capture and manual measurements.
                </AlertDescription>
              </Alert>
            )}
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center space-y-4">
                              <div className="text-center space-y-2">
                                ...
                                <p className="text-sm text-gray-500">
                                  Capture before, after, and progress photos
                                </p>
                              </div>
                          ...
                          {capturedImages.length > 0 && (
                            <div className="space-y-4">
                              ...
                              <div className="relative">
                                <img
                                  src={
                                    capturedImages[currentImageIndex]?.dataUrl
                                  }
                      ...
                      {beforeImage && afterImage ? (
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <Select
                                ...
                                onValueChange={(
                                  value: "side-by-side" | "overlay" | "slider",
                        ...
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-400 mb-2">
                            Comparison requires both before and after images
                          </p>
                          <p className="text-sm text-gray-500">
                            {!beforeImage && 'Capture a "before" image first'}
                            {beforeImage &&
                              !afterImage &&
                              'Now capture an "after" image'}
                          </p>
                        </div>
                      )}
                    </TabsContent>
                      ...
                      <div className="space-y-4">
                        <div className="bg-gray-900 p-3 rounded">
                          <p className="text-sm text-gray-400 mb-3">
                            Click on the image to add damage annotations
                          </p>
                        ...
                        {capturedImages.length > 0 &&
                          annotations.length === 0 && (
                            <div className="text-center py-8 text-gray-500">
                              ...
                              <p className="text-sm">
                                Document severity and damage type
                              </p>
                            </div>
                          )}
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-gray-900 p-4 rounded-lg">
                          ...
                          <p className="text-gray-400 text-sm mb-4">
                            Add digital notes directly in your rooms. Pin
                            important information about equipment, maintenance,
                            or access points.
                          </p>
                                ...
                                return (
                                  ...
                                  >
                                    <div className="relative group">
                                      <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center ${note.color} cursor-pointer hover:scale-110 transition-transform`}
                                      >
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-black/50">
                                  <div className="text-center">
                                    ...
                                    <p className="text-white font-medium">
                                      Click unknownwhere to add an AR note
                                    </p>
                                    <p className="text-gray-400 text-sm mt-1">
                                      Document equipment locations and important
                                      details
                                    </p>
                                  </div>
                                </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-gray-900 p-4 rounded-lg">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-white font-medium">
                              Enhanced AI Damage Analysis
                            </h3>
                          </div>
                          <p className="text-gray-400 text-sm mb-4">
                            Get comprehensive AI analysis with policy
                            comparison, before/after evaluation, and detailed
                            recommendations.
                          </p>
                    ...
                    {measurements.length === 0 ? (
                      <div className="text-center py-4">
                        ...
                        <p className="text-xs text-gray-500">
                          Use AR tools to measure damage
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-2">
                          ...
                          >
                            ...
                            {measurement.realWorldDistance && (
                              <div className="text-xs text-gray-400">
                                AR Calibrated: {measurement.realWorldDistance}{" "}
                                {measurement.unit}
                              </div>
                            )}
                          </div>
                  ...
                  <CardContent>
                    {annotations.length === 0 ? (
                      <div className="text-center py-4">
                        ...
                        <p className="text-xs text-gray-500">
                          Click on damage areas to annotate
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-3">
                  ...
                  <CardContent>
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                        <span className="text-gray-300">
                          3D visualization helps insurers understand damage
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                        <span className="text-gray-300">
                          Professional reports increase claim success
                        </span>
                      </div>
                    </div>
                  </CardContent>
