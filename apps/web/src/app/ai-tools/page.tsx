...
const AI_TOOLS: AITool[] = [
  ...
  },
  {
    ...
    description:
      "Professional documentation in minutes! WebXR measurement tools with AI validation and 3D visualization",
    icon: Camera,
    color: "cyan",
  ...
  },
  {
    ...
    description:
      "AI-powered damage assessment from photos with instant severity ratings and repair recommendations",
    icon: Camera,
    color: "orange",
  ...
  },
  {
    ...
    description:
      "It caught issues I never would have noticed! Pre-submission review with claim strength scoring",
    icon: Shield,
    color: "emerald",
  ...
  },
  {
    ...
    description:
      "Get instant answers about your insurance policy with integrated explanations and plain English translations",
    icon: Shield,
    color: "blue",
  ...
  },
  {
    ...
    description:
      "Automatically catalog your belongings with AI-powered recognition and value estimation",
    icon: FolderOpen,
    color: "purple",
  ...
  },
  {
    ...
    description:
      "Scan and extract data from receipts, invoices, and estimates with advanced OCR technology",
    icon: Receipt,
    color: "amber",
  ...
  },
  {
    ...
    description:
      "Create accurate floor plans with your phone! Keep scanning your whole home and get professional measurements",
    icon: Home,
    color: "blue",
  ...
  },
  {
    ...
    description:
      "Create tax-deductible donation forms by taking pictures of items. AI estimates Fair Market Value",
    icon: Package,
    color: "green",
  ...
  },
  {
    ...
    description:
      "Create 3D models of damage from multiple photos for comprehensive documentation",
    icon: Zap,
    color: "cyan",
  ...
  },
  {
    ...
    description:
      "Step-by-step guidance through the claim filing process with document preparation",
    icon: FileText,
    color: "green",
  ...
  },
  {
    ...
    description:
      "Generate professional claim letters, appeals, and supporting documentation",
    icon: FileSearch,
    color: "indigo",
  ...
  },
  {
    ...
    description:
      "AI-powered assistance for writing emails and messages to insurance companies",
    icon: MessageSquare,
    color: "pink",
  ...
  },
  {
    ...
    description:
      "Analyze settlement offers and compare with typical payouts for similar claims",
    icon: Calculator,
    color: "yellow",
  ...
  },
  {
    ...
    description:
      "AI-powered assistance for writing emails and messages with integrated negotiation guidance and tactics",
    icon: MessageSquare,
    color: "pink",
    href: "/ai-tools/communication-helper",
    status: "beta",
  ...
  },
  {
    ...
    description:
      "Revolutionary collaborative damage assessment! Multiple users work together with AI to create consensus-based damage reports",
    icon: Bot,
    color: "cyan",
  ...
  },
  {
    ...
    description:
      "Your AI photography coach! Get real-time guidance to capture perfect damage documentation with optimal quality",
    icon: Camera,
    color: "emerald",
  ...
  },
  {
    ...
    description:
      "Analyze any webpage for SEO, accessibility, performance, and content quality with AI-powered insights",
    icon: Globe,
    color: "purple",
      ...
      <DashboardLayout>
        <div className="p-6">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="text-center mb-12">
              <div className="relative">
                ...
                <div className="relative flex items-center justify-center gap-3 mb-6">
                  <div className="p-4 liquid-glass-premium rounded-2xl shadow-[0_20px_60px_rgba(59,130,246,0.3)] hover:shadow-[0_25px_80px_rgba(147,51,234,0.4)] transition-all duration-700">
                  ...
                  <h1 className="text-5xl font-bold">
                    ...
                    <span className="block mt-2 text-4xl bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(59,130,246,0.5)]">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8 drop-shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
                Turn complex claims into simple wins. Each tool maximizes your
                settlement and minimizes your stress.
              </p>
              <div className="flex flex-wrap justify-center items-center gap-6 text-sm">
                <Badge
                  variant="outline"
                  className="liquid-glass-success text-green-400 shadow-[0_8px_32px_rgba(34,197,94,0.15)] hover:shadow-[0_8px_32px_rgba(34,197,94,0.25)] transition-all duration-300"
                >
                  <CheckCircle className="w-3 h-3 mr-1 drop-shadow-[0_0_8px_rgba(34,197,94,0.6)]" />
                  {AI_TOOLS.filter((t) => t.status === "active").length} Tools
                  Ready
                </Badge>
                <Badge
                  variant="outline"
                  className="liquid-glass-info text-blue-400 shadow-[0_8px_32px_rgba(59,130,246,0.15)] hover:shadow-[0_8px_32px_rgba(59,130,246,0.25)] transition-all duration-300"
                >
                ...
                <Badge
                  variant="outline"
                  className="liquid-glass-3 text-purple-400 border-purple-400/30 shadow-[0_8px_32px_rgba(147,51,234,0.15)] hover:shadow-[0_8px_32px_rgba(147,51,234,0.25)] transition-all duration-300"
                >
            ...
            {/* Premium Status Bar */}
            <Card className="liquid-glass-4 border-gray-700/50 shadow-[0_20px_60px_rgba(0,0,0,0.4)] hover:shadow-[0_25px_80px_rgba(59,130,246,0.15)] transition-all duration-500">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6 text-sm">
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-2 h-2 rounded-full ${hasOpenAIKey ? "bg-green-400" : "bg-red-400"}`}
                      />
                      <span className="text-gray-400">
                        OpenAI: {hasOpenAIKey ? "Connected" : "Key Required"}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-2 h-2 rounded-full ${hasGeminiKey ? "bg-green-400" : "bg-red-400"}`}
                      />
                      <span className="text-gray-400">
                        Gemini: {hasGeminiKey ? "Connected" : "Key Required"}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      {isOnline ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredTools.map((tool) => {
                ...
                const isDisabled =
                  ...
                  (!hasOpenAIKey && !hasGeminiKey && tool.status === "active");

                return (
                  <Card
                    key={tool.id}
                    className={`liquid-glass-3 border-gray-700/50 overflow-hidden transition-all duration-500 shadow-[0_12px_40px_rgba(0,0,0,0.3)] ${
                      !isDisabled
                  ...
                  >
                    <CardHeader className="pb-4">
                      <div className="flex items-start justify-between mb-3">
                        <div
                          className={`p-3 rounded-xl liquid-glass-2 bg-${tool.color}-600/20 shadow-[0_8px_32px_rgba(59,130,246,0.2)] hover:shadow-[0_12px_40px_rgba(59,130,246,0.3)] transition-all duration-300`}
                        >
                          <Icon
                            className={`h-6 w-6 text-${tool.color}-300 drop-shadow-[0_0_12px_rgba(59,130,246,0.6)]`}
                          />
                        </div>
                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-3">
                        ...
                        {tool.status === "coming-soon" ? (
                          ...
                          >
                            <Button
                              className="w-full liquid-glass-premium bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-[0_8px_32px_rgba(59,130,246,0.3)] hover:shadow-[0_12px_40px_rgba(59,130,246,0.4)] transition-all duration-300 border-0"
            ...
            <Card className="liquid-glass-premium border-blue-600/40 shadow-[0_20px_60px_rgba(59,130,246,0.2)] hover:shadow-[0_25px_80px_rgba(59,130,246,0.3)] transition-all duration-500">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <div className="p-4 liquid-glass-info rounded-xl shadow-[0_8px_32px_rgba(59,130,246,0.3)]">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300 text-sm mb-4">
                      Our AI tools are designed to make the insurance claim
                      process easier and more effective. Each tool uses advanced
                      AI models to analyze your specific situation and provide
