...
export default function DonationAssistantPage() {
  ...
  const calculateFairMarketValue = (item: Partial<DonationItem>) => {
    ...
    const fmv =
      baseValue *
      (conditionMultiplier[
        item.condition as keyof typeof conditionMultiplier
      ] || 0.25);
  ...
  const handleImageCapture = async (file: File) => {
    ...
    setTimeout(() => {
      ...
      setCurrentItem({
        ...currentItem,
        ...mockResults,
        fairMarketValue: calculateFairMarketValue({
          ...currentItem,
          ...mockResults,
        }),
      });
  ...
  const addItem = () => {
    ...
    const newItem: DonationItem = {
      ...
      fairMarketValue:
        currentItem.fairMarketValue || calculateFairMarketValue(currentItem),
  ...
  const getTotalValue = () => {
    return items.reduce(
      (total, item) => total + item.fairMarketValue * item.quantity,
      0,
    );
  };
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-400 max-w-3xl">
                Create tax-deductible donation forms by taking pictures of
                items. AI estimates Fair Market Value automatically.
              </p>
            </div>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => {
                              setCurrentItem({
                                ...currentItem,
                                condition: value as DonationItem["condition"],
                              });
                              if (
                                ...
                                setCurrentItem((prev) => ({
                                  ...
                                  fairMarketValue: calculateFairMarketValue({
                                    ...prev,
                                    condition:
                                      value as DonationItem["condition"],
                                  }),
                                }));
                              }
                            }}
                        ...
                        {/* Fair Market Value */}
                        <div>
                          <Label htmlFor="fmv" className="text-white">
                            Fair Market Value ($)
                          </Label>
                ...
                <Card className="bg-gray-800 border-gray-700 mt-6">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label htmlFor="donationDate" className="text-white">
                          Donation Date
                        </Label>
                        <Input
                          id="donationDate"
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-green-400 font-medium mt-1">
                                  $
                                  {(
                                    item.fairMarketValue * item.quantity
                                  ).toFixed(2)}
                                </p>
                              </div>
                            </div>
                  ...
                  <CardContent>
                    ...
                    <Alert className="mt-4 bg-blue-900/20 border-blue-600/30">
                      ...
                      <AlertDescription className="text-blue-200">
                        Save this receipt for your tax records. Donations over
                        $250 require written acknowledgment from the charity.
                      </AlertDescription>
                    </Alert>
                  </CardContent>
                </Card>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-gray-300">
                          Keep photos and receipts for all donations
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
                        <TrendingUp className="h-4 w-4 text-green-400 mt-0.5" />
                        <span className="text-gray-300">
                          FMV based on thrift store prices
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
