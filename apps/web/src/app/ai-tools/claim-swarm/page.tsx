      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Collaborate with other users to assess property damage using
            AI-powered analysis. Multiple perspectives improve accuracy and
            provide consensus-based assessments.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-400">
                Take photos of property damage using your camera or upload
                existing images.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-400">
                Our AI analyzes damage severity, estimated costs, and provides
                detailed findings.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-400">
                Multiple assessments are combined into a consensus report for
                maximum accuracy.
              </p>
            </div>
          </div>
