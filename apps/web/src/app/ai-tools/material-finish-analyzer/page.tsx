...
export default function MaterialFinishAnalyzerPage() {
  ...
  const generateReport = () => {
    const report = {
      ...
      analyses: analyses,
      totalReplacementValue: analyses.reduce(
        (sum, a) => sum + a.valuation.replacementCost,
        0,
      ),
      recommendations: {
        immediate: analyses.filter((a) => a.condition.rating === "poor").length,
        routine: analyses.filter((a) => a.condition.rating === "fair").length,
        preventive: analyses.filter(
          (a) =>
            a.condition.rating === "good" || a.condition.rating === "excellent",
        ).length,
      },
    };
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-400 max-w-3xl">
                Instantly identify materials, finishes, and get replacement cost
                estimates. Perfect for insurance documentation and home
                      ...
                      <div className="space-y-4">
                        ...
                        <Alert className="bg-blue-900/20 border-blue-600/30">
                          ...
                          <AlertDescription className="text-blue-200">
                            For best results, capture materials in good lighting
                            with clear texture visible. Include any labels or
                            markings.
                          </AlertDescription>
                        </Alert>
                      </div>
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                              <div className="bg-black/80 rounded-lg p-6">
                                ...
                                <p className="text-xs text-gray-400 mt-2">
                                  Identifying patterns and textures
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="relative">
                              ...
                              <div className="absolute top-4 right-4 bg-black/60 backdrop-blur-sm rounded-lg px-3 py-1">
                                <p className="text-white text-sm font-medium flex items-center gap-2">
                                  ...
                                  {Math.round(
                                    selectedAnalysis.material.confidence * 100,
                                  )}
                                  % Confidence
                                </p>
                              </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="bg-gray-700/50 rounded-lg p-4">
                                ...
                                <p className="text-lg font-semibold text-white">
                                  {selectedAnalysis.material.type}
                                </p>
                                <p className="text-sm text-gray-300">
                                  {selectedAnalysis.material.subType}
                                </p>
                              </div>
                              <div className="bg-gray-700/50 rounded-lg p-4">
                                <h4 className="text-sm text-gray-400 mb-1">
                                ...
                                <p className="text-lg font-semibold text-white">
                                  {selectedAnalysis.finish.type}
                                </p>
                                <p className="text-sm text-gray-300">
                                  {selectedAnalysis.finish.sheen}
                                </p>
                              </div>
                              <div className="bg-gray-700/50 rounded-lg p-4">
                                <h4 className="text-sm text-gray-400 mb-1">
                                ...
                                <p className="text-sm text-gray-300 mt-1">
                                  {selectedAnalysis.condition.age}
                                </p>
                              </div>
                              <div className="bg-gray-700/50 rounded-lg p-4">
                                <h4 className="text-sm text-gray-400 mb-1">
                      ...
                      <div className="pt-2 space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm text-green-400">
                            {
                              analyses.filter(
                                (a) => a.condition.rating === "excellent",
                              ).length
                            }{" "}
                            items
                          </span>
                          ...
                          <span className="text-sm text-orange-400">
                            {
                              analyses.filter(
                                (a) =>
                                  a.condition.rating === "fair" ||
                                  a.condition.rating === "poor",
                              ).length
                            }{" "}
                            items
                          </span>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-gray-300">
                          Natural lighting reveals true colors and textures
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Camera className="h-4 w-4 text-blue-400 mt-0.5" />
                        <span className="text-gray-300">
                          Include edges and joints for accurate identification
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
                        <Shield className="h-4 w-4 text-green-400 mt-0.5" />
                        <span className="text-gray-300">
                          Document for insurance claims and renovations
                        </span>
                      </div>
                    </div>
                  </CardContent>
