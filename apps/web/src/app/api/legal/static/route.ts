...
const LEGAL_DOCS = {
  privacy_policy: {
    ...
    summary:
      "Learn how ClaimGuardian protects your personal information and privacy rights.",
  },
  terms_of_service: {
    file: "terms-of-service.md",
    title: "Terms of Service",
    summary:
      "Understand the terms and conditions for using ClaimGuardian services.",
  },
  ai_use_agreement: {
    file: "ai-disclaimer.md",
    title: "AI Use Agreement",
    summary:
      "Important information about our AI-powered features and limitations.",
  },
};
