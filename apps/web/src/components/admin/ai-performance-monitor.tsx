...
export function AIPerformanceMonitor() {
  ...
  const [featurePerformance, setFeaturePerformance] =
    useState<FeaturePerformance[]>(MOCK_FEATURES);
  ...
  const checkThresholds = useCallback(
    (newMetrics: RealTimeMetrics) => {
      ...
      if (newMetrics.cpuUsage > thresholds.cpuUsage) {
        newAlerts.push(
          generateAlert("CPU Usage", newMetrics.cpuUsage, thresholds.cpuUsage),
        );
      }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">
            Live monitoring of AI operations performance
          </p>
        </div>
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            ...
            <Progress
              value={
                currentMetrics
                  ? Math.min((currentMetrics.responseTime / 3000) * 100, 100)
                  : 0
              }
              className="h-2 mt-2"
            />
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            ...
            <Progress
              value={
                currentMetrics
                  ? Math.min((currentMetrics.errorRate / 10) * 100, 100)
                  : 0
              }
              className="h-2 mt-2"
            />
