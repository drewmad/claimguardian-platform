  ...
  const loadRevenueData = async () => {
    try {
      ...
      setSegments([
        ...
        {
          segment: "Small Landlords (2-5 properties)",
          count: 189,
          revenue: 15113,
          avg_ltv: 4200,
          churn_rate: 4.2,
        ...
        {
          segment: "Insurance Professionals",
          count: 26,
          revenue: 5173,
          avg_ltv: 12400,
          churn_rate: 1.8,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">
              CAC: {formatCurrency(metrics?.cac || 0)} | Ratio:{" "}
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">
              {metrics?.churn_rate?.toFixed(1) || "0.0"}%
            </div>
            <p className="text-xs text-gray-500 mt-1">
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{
                            backgroundColor:
                              TIER_COLORS[
                                tier.tier as keyof typeof TIER_COLORS
                              ],
                          }}
                        />
