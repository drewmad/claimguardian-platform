...
export function PermissionsManagement() {
  ...
  const handleCreateOverride = async () => {
    try {
      if (
        !newOverride.userEmail ||
        !newOverride.permission ||
        !newOverride.access
      ) {
  ...
  const filteredPermissions = allPermissions.filter((permission) => {
    ...
    const matchesRisk =
      filterRisk === "all" || permission.risk_level === filterRisk;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Configure tier permissions and access control
          </p>
        </div>
        <div className="flex gap-2">
          {unsavedChanges && (
            <Button
              onClick={saveTierPermissions}
        ...
        <TabsContent value="matrix" className="space-y-4">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              ...
              <CardDescription>
                Select a tier to configure its permissions
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      <span className="capitalize">
                        {selectedTierData.tier} Tier Permissions
                      </span>
                    </CardTitle>
                    <CardDescription>
                    ...
                    <div key={groupIndex}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {group.permissions.map((permission) => {
                          const hasPermission =
                            selectedTierData.permissions.includes(
                              permission.type,
                            );
                              ...
                              <div className="flex items-start justify-between mb-2">
                                <div className="flex-1">
                                  ...
                                  {permission.requires_subscription && (
                                    <Badge
                                      variant="outline"
                                      className="text-xs mt-1 border-purple-500 text-purple-500"
                                    >
                                      Premium
                                    </Badge>
                                  )}
        ...
        <TabsContent value="detailed" className="space-y-4">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              ...
              <CardDescription>
                Detailed view of all permissions and their configurations
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  {filteredPermissions.map((permission) => (
                    <TableRow key={permission.type} className="border-gray-700">
                      ...
                      <TableCell>
                        <Badge
                          variant="outline"
                          className={getRiskColor(permission.risk_level)}
                        >
                          {permission.risk_level}
                        </Badge>
                      </TableCell>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Manage custom permission overrides for specific users
                  </CardDescription>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewOverride((prev) => ({ ...prev, permission: value }))
                }
              >
            ...
            <div>
              ...
              <Select
                value={newOverride.access}
                onValueChange={(value) =>
                  setNewOverride((prev) => ({ ...prev, access: value }))
                }
              >
                <SelectTrigger className="bg-gray-800 border-gray-700">
