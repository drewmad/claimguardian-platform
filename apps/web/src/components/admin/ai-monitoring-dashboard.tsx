...
export function AIMonitoringDashboard() {
    ...
    const mockAlerts: SystemAlert[] = [
      {
        ...
        severity: "warning",
        message:
          "Claim predictor AI error rate increased to 3.7% in the last hour",
  ...
  const performanceData = [
    {
      time: "00:00",
      predictive_maintenance: 98,
      fraud_detection: 97,
      sentiment_analysis: 99,
      claim_predictor: 95,
    },
    {
      time: "06:00",
      predictive_maintenance: 97,
      fraud_detection: 98,
      sentiment_analysis: 98,
      claim_predictor: 96,
    },
    {
      time: "12:00",
      predictive_maintenance: 99,
      fraud_detection: 96,
      sentiment_analysis: 97,
      claim_predictor: 94,
    },
    {
      time: "18:00",
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Monitor AI system performance, costs, and alerts
          </p>
        </div>
                ...
                .map((alert) => (
                  ...
                  >
                    ...
                    <AlertTitle className="flex items-center justify-between">
                      <span>
                        {alert.system} - {alert.severity.toUpperCase()}
                      </span>
                      <div className="flex items-center space-x-2">
          ...
          <div className="grid gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Success rates for all AI systems (24-hour view)
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={performanceData}>
                    ...
                    <Line
                      type="monotone"
                      dataKey="predictive_maintenance"
                      stroke="#8884d8"
                      name="Predictive Maintenance"
                    />
                    <Line
                      type="monotone"
                      dataKey="fraud_detection"
                      stroke="#82ca9d"
                    ...
                    <Line
                      type="monotone"
                      dataKey="claim_predictor"
                      stroke="#ff7300"
                      name="Claim Predictor"
                    />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
        ...
        <TabsContent value="functions">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Performance metrics for deployed Edge Functions
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="models">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Usage statistics and performance for AI models
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {model.requests_24h} requests,{" "}
                          {(model.tokens_used / 1000).toFixed(1)}K tokens
                        </p>
                      </div>
        ...
        <TabsContent value="performance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Comprehensive performance analysis across all systems
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-6">
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    All AI systems are performing within normal parameters.
                    Average response times have improved 15% over the past week
                    due to optimization efforts.
                  </AlertDescription>
                </Alert>
              </div>
            </CardContent>
        ...
        <TabsContent value="costs">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cost breakdown and trends for AI service usage
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
