    ...
    try {
      ...
      const mockTrends = Array.from({ length: 12 }, (_, i) => {
        ...
        return {
          ...
          total_value:
            (25 + Math.floor(Math.random() * 50)) * (280000 + i * 2000),
      ...
      const mockGeographic: GeographicDistribution[] = [
        {
          ...
          property_count: 1234,
          avg_value: 425000,
          total_value: 524550000,
          avg_insurance: 2150,
          risk_score: 75,
          hurricane_properties: 892,
          flood_properties: 567,
        },
        {
          county: "Broward",
          property_count: 987,
          avg_value: 385000,
          total_value: 379995000,
          avg_insurance: 1950,
          risk_score: 72,
          hurricane_properties: 654,
          flood_properties: 432,
        },
        {
          county: "Palm Beach",
          property_count: 756,
          avg_value: 515000,
          total_value: 389340000,
          avg_insurance: 2350,
          risk_score: 68,
          hurricane_properties: 423,
          flood_properties: 289,
        },
        {
          county: "Orange",
          property_count: 543,
          avg_value: 275000,
          total_value: 149325000,
          avg_insurance: 1450,
          risk_score: 45,
          hurricane_properties: 123,
          flood_properties: 87,
        },
        {
          county: "Hillsborough",
          property_count: 432,
          avg_value: 315000,
          total_value: 136080000,
          avg_insurance: 1650,
          risk_score: 58,
          hurricane_properties: 234,
          flood_properties: 156,
        },
        {
          county: "Lee",
          property_count: 389,
          avg_value: 395000,
          total_value: 153755000,
          avg_insurance: 1850,
          risk_score: 82,
          hurricane_properties: 345,
          flood_properties: 267,
        },
        {
          county: "Collier",
          property_count: 226,
          avg_value: 685000,
          total_value: 154810000,
          avg_insurance: 2750,
          risk_score: 79,
          hurricane_properties: 198,
          flood_properties: 134,
        },
      ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Geographic insights, risk assessment, and market analysis
          </p>
        </div>
      ...
      {riskAssessments.filter((r) => r.risk_score >= 85).length > 0 && (
        <Alert className="bg-red-900/20 border-red-900">
          ...
          <AlertDescription>
            <strong>
              {riskAssessments.filter((r) => r.risk_score >= 85).length}{" "}
              properties with critical risk scores
            </strong>{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">
              {overview?.total_properties.toLocaleString() || "0"}
            </div>
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Avg premium:{" "}
              {formatCurrency(overview?.avg_insurance_premium || 0)}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">
              {overview?.hurricane_zone_properties.toLocaleString() || "0"}
            </div>
            <p className="text-xs text-gray-500 mt-1">
              {overview
                ? (
                    (overview.hurricane_zone_properties /
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">
              {overview?.underinsured_properties || 0}
            </div>
            <p className="text-xs text-gray-500 mt-1">
              {overview
                ? (
                    (overview.underinsured_properties /
                      overview.total_properties) *
                    100
                  ).toFixed(1)
                : "0"}
                        ...
                        <Cell
                          ...
                          fill={
                            PROPERTY_TYPE_COLORS[
                              entry.type as keyof typeof PROPERTY_TYPE_COLORS
                            ] || "#6B7280"
                          }
                        />
                      ))}
                  ...
                  <tbody>
                    {propertyTypes.map((type, idx) => (
                      <tr key={idx} className="border-b border-gray-700/50">
                          ...
                          <div className="flex items-center gap-2">
                            <div
                              ...
                              style={{
                                backgroundColor:
                                  PROPERTY_TYPE_COLORS[
                                    type.type as keyof typeof PROPERTY_TYPE_COLORS
                                  ] || "#6B7280",
                              }}
                            />
                        ...
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(type.avg_value)}
                        </td>
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(type.avg_insurance)}
                        </td>
                        <td className="text-center py-3">
                          <Badge
                            variant="outline"
                            className={
                              type.risk_level === "high"
                                ? "border-red-500 text-red-500"
                                : type.risk_level === "medium"
                    ...
                    {riskAssessments.map((property, idx) => (
                      <tr key={idx} className="border-b border-gray-700/50">
                        ...
                        <td className="text-right py-3">
                          <span
                            className={
                              property.coverage_gap > 100000
                                ? "text-red-400"
                                : property.coverage_gap > 50000
                                  ? "text-yellow-400"
                                  : "text-gray-300"
                            }
                          >
                        ...
                        <td className="text-center py-3">
                          <Badge
                            ...
                            style={{
                              borderColor:
                                HURRICANE_ZONE_COLORS[
                                  property.hurricane_zone as keyof typeof HURRICANE_ZONE_COLORS
                                ],
                              color:
                                HURRICANE_ZONE_COLORS[
                                  property.hurricane_zone as keyof typeof HURRICANE_ZONE_COLORS
                  ...
                  <tbody>
                    {geographic.map((geo, idx) => (
                      <tr key={idx} className="border-b border-gray-700/50">
                        ...
                        <td className="text-right py-3 text-gray-300">
                          {geo.property_count.toLocaleString()}
                        </td>
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(geo.avg_value)}
                        </td>
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(geo.total_value)}
                        </td>
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(geo.avg_insurance)}
                        </td>
                        <td className="text-center py-3">
                          <div className="flex items-center justify-center space-x-2">
                            <div
                              className="w-2 h-2 rounded-full"
                              style={{
                                backgroundColor: getRiskColor(geo.risk_score),
                              }}
                            />
                            <span className="text-gray-300">
                              {geo.risk_score}
                        ...
                        <td className="text-right py-3">
                          <span
                            className={
                              geo.hurricane_properties >
                              geo.property_count * 0.5
                                ? "text-red-400"
                                : geo.hurricane_properties >
                                    geo.property_count * 0.25
                                  ? "text-yellow-400"
                                  : "text-gray-300"
                            }
                          >
                            {geo.hurricane_properties} (
                            {(
                              (geo.hurricane_properties / geo.property_count) *
                              100
                            ).toFixed(1)}
                            %)
                          </span>
                        ...
                        <td className="text-right py-3">
                          <span
                            className={
                              geo.flood_properties > geo.property_count * 0.3
                                ? "text-blue-400"
                                : "text-gray-300"
                            }
                          >
                            {geo.flood_properties} (
                            {(
                              (geo.flood_properties / geo.property_count) *
                              100
                            ).toFixed(1)}
                            %)
                          </span>
                  ...
                  <tbody>
                    {marketAnalysis.map((market, idx) => (
                      <tr key={idx} className="border-b border-gray-700/50">
                        ...
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(market.avg_sale_price)}
                        </td>
                        <td className="text-center py-3">
                          <span
                            className={
                          ...
                          >
                            {market.price_change_pct >= 0 ? "+" : ""}
                            {market.price_change_pct.toFixed(1)}%
                          </span>
                        </td>
                        <td className="text-right py-3 text-gray-300">
                          {market.inventory_months.toFixed(1)}
                        </td>
                        <td className="text-center py-3">
                          <div className="flex items-center justify-center space-x-2">
                            {getMarketTrendIcon(market.market_trend)}
                            <span
                              className={getMarketTrendColor(
                                market.market_trend,
                              )}
                            >
                              {market.market_trend}
                  ...
                  <tbody>
                    {insuranceGaps.map((gap, idx) => (
                      <tr key={idx} className="border-b border-gray-700/50">
                        ...
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(gap.property_value)}
                        </td>
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(gap.insurance_coverage)}
                        </td>
                        <td className="text-right py-3">
                          <span
                            className={
                              gap.gap_percentage > 40
                                ? "text-red-400"
                        ...
                        <td className="text-right py-3 text-gray-300">
                          {formatCurrency(gap.recommended_coverage)}
                        </td>
                        <td className="text-right py-3 text-gray-300">
                          +{formatCurrency(gap.annual_premium_impact)}/yr
                        </td>
                      </tr>
                    ))}
                  </tbody>
