...
export function RealTimeAnalyticsDashboard() {
  ...
  const featureDistribution = currentStats.topFeatures.map((feature) => ({
    ...
    cost: feature.cost,
    fill:
      FEATURE_COLORS[feature.featureId as keyof typeof FEATURE_COLORS] ||
      "#6B7280",
  }));
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">
            Live AI operations monitoring and insights
          </p>
        </div>
            ...
            {historicalData.length > 1 && (
              <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                {calculateTrend(
                  ...
                  historicalData[historicalData.length - 2].metrics
                    .totalRequests,
                ) === "up" ? (
                        ...
                        <div className="flex items-center gap-3">
                          <div
                            ...
                            style={{
                              backgroundColor:
                                FEATURE_COLORS[
                                  feature.featureId as keyof typeof FEATURE_COLORS
                                ] || "#6B7280",
                            }}
                          />
                  ...
                  {currentStats.modelPerformance.map((model, index) => (
                    <div key={model.model} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={
                            model.errorRate > 5 ? "destructive" : "default"
                          }
                        >
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-white">
                      ...
                      {currentStats.totalRequests > 0
                        ? (
                            currentStats.totalCost / currentStats.totalRequests
                          ).toFixed(4)
                        : "0.0000"}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-white">
                      ...
                      {currentStats.activeUsers > 0
                        ? (
                            currentStats.totalCost / currentStats.activeUsers
                          ).toFixed(2)
                        : "0.00"}
                    </span>
                  </div>
                ...
                {currentStats.errorRate > 5 && (
                  <div className="p-3 bg-red-900/20 border border-red-600/30 rounded-lg">
                    ...
                    <p className="text-sm text-gray-300">
                      {currentStats.errorRate.toFixed(1)}% of requests are
                      failing
                    </p>
                  </div>
                )}
