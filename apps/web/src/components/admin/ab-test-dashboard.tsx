...
const MOCK_RECENT_FEEDBACK: QualityFeedback[] = [
  {
    ...
    accuracy: 5,
    comment:
      "Very accurate damage assessment, helped me understand what to expect.",
...
export function ABTestDashboard() {
  ...
  const calculateWinner = (test: ABTest) => {
    ...
    const scoreA =
      model_a.success_rate * 0.4 +
      model_a.user_rating * 20 +
      (3000 - model_a.avg_time * 1000) / 30;
    const scoreB =
      model_b.success_rate * 0.4 +
      model_b.user_rating * 20 +
      (3000 - model_b.avg_time * 1000) / 30;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">
            Monitor and analyze AI model performance tests
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-2xl font-bold">
              {abTests
                .reduce(
                  (sum, test) =>
                    sum +
                    test.metrics.model_a.requests +
                    test.metrics.model_b.requests,
                  0,
                )
                .toLocaleString()}
            </div>
        ...
        <Card className={liquidGlass.cards.default}>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {abTests.reduce(
                (sum, test) => sum + test.quality_feedback.total_responses,
                0,
              )}
            </div>
            <p className="text-xs text-muted-foreground">
              {(
                abTests.reduce(
                  (sum, test) => sum + test.quality_feedback.helpful_percentage,
                  0,
                ) / abTests.length
              ).toFixed(1)}
              % helpful
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {(
                abTests.reduce(
                  (sum, test) =>
                    sum + test.quality_feedback.avg_accuracy_rating,
                  0,
                ) / abTests.length
              ).toFixed(1)}
            </div>
                    ...
                    <div className="p-3 bg-green-900/20 border border-green-600/30 rounded-lg">
                      ...
                      <div className="space-y-1 text-xs">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-white">
                            {test.metrics.model_a.success_rate}%
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Rating:</span>
                          <span className="text-white">
                            {test.metrics.model_a.user_rating}/5
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-3 bg-purple-900/20 border border-purple-600/30 rounded-lg">
                      ...
                      <div className="space-y-1 text-xs">
                        ...
                        <div className="flex justify-between">
                          <span className="text-gray-400">Success:</span>
                          <span className="text-white">
                            {test.metrics.model_b.success_rate}%
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Rating:</span>
                          <span className="text-white">
                            {test.metrics.model_b.user_rating}/5
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          {test.start_date} → {test.end_date} • Feature:{" "}
                          {test.feature_id}
                        </p>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-white">
                              {(
                                (test.quality_feedback.total_responses /
                                  (test.metrics.model_a.requests +
                                    test.metrics.model_b.requests)) *
                                100
                              ).toFixed(1)}
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-white">
                              {test.quality_feedback.avg_accuracy_rating}/5
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-white">
                              {test.metrics.model_a.avg_time}s
                            </span>
                          </div>
                          <div className="flex justify-between">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            <span className="text-gray-400">Avg Response:</span>
                            <span className="text-white">
                              {test.metrics.model_b.avg_time}s
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-400">User Rating:</span>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-white">
                      {abTests.reduce(
                        (sum, test) =>
                          sum + test.quality_feedback.total_responses,
                        0,
                      )}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-green-400">
                      {(
                        abTests.reduce(
                          (sum, test) =>
                            sum + test.quality_feedback.helpful_percentage,
                          0,
                        ) / abTests.length
                      ).toFixed(1)}
                      %
            ...
            <div className="lg:col-span-2">
              <Card className={liquidGlass.cards.default}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Latest quality feedback from users
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
