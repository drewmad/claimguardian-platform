...
export function PermissionAnalyticsDashboard() {
  ...
  const totalActiveUsers = tierAnalytics.reduce(
    (sum, tier) => sum + tier.activeUsers,
    0,
  );
  const totalRevenue = tierAnalytics.reduce(
    (sum, tier) => sum + tier.revenue,
    0,
  );
  const avgSuccessRate =
    permissionStats.reduce((sum, stat) => sum + stat.successRate, 0) /
    permissionStats.length;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <Select
            value={selectedTier}
            onValueChange={(value: UserTier | "all") => setSelectedTier(value)}
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              Most used permissions and their performance metrics
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
                  ...
                  <TableRow key={stat.permission} className="border-gray-700">
                    ...
                    <TableCell>
                      <div className="text-sm">
                        ...
                        <div className="text-xs text-gray-400">
                          of {stat.totalUsers.toLocaleString()}
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              User distribution and revenue by subscription tier
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
                  ...
                  <TableRow key={tier.tier} className="border-gray-700">
                    ...
                    <TableCell>
                      <div className="text-sm">
                        ...
                        <div className="text-xs text-gray-400">
                          of {tier.totalUsers.toLocaleString()}
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div
                        className={`text-sm ${tier.churnRate > 10 ? "text-red-500" : tier.churnRate > 5 ? "text-yellow-500" : "text-green-500"}`}
                      >
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Recent permission violations and security alerts
              </CardDescription>
            </div>
            ...
            <TableBody>
              {violations.map((violation) => (
                <TableRow key={violation.id} className="border-gray-700">
                  ...
                  <TableCell>
                    <div className="text-sm text-white">
                      {formatPermissionName(violation.permission)}
                    </div>
                  </TableCell>
                  <TableCell>
                    <div className="text-sm text-white">
      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardHeader>
          ...
          <CardDescription>
            Weekly usage trends and performance metrics
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-500">
                      {(
                        (pattern.successfulRequests / pattern.totalRequests) *
                        100
                      ).toFixed(1)}
                      %
                    </span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">
                      {pattern.avgResponseTime.toFixed(1)}s
                    </span>
                  </div>
                  <div className="flex justify-between">
