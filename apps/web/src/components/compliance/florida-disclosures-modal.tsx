      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-base mt-2">
            Before we can assist with your insurance claim, Florida law requires
            us to provide these important disclosures. Please read and
              ...
              <div className="flex-1">
                ...
                <Alert className="bg-yellow-50 border-yellow-200">
                  <AlertDescription className="text-sm text-gray-700">
                    <strong>IMPORTANT:</strong> ClaimGuardian is NOT a licensed
                    public adjuster. Under Florida Statute 626.854, only
                    licensed public adjusters can negotiate with insurance
                    companies on your behalf for a fee. Our AI tools provide
                    information and document organization assistance only. We do
                    not negotiate settlements or represent you in dealings with
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <Alert className="bg-yellow-50 border-yellow-200">
                  <AlertDescription className="text-sm text-gray-700">
                    ClaimGuardian does not provide legal advice or legal
                    representation. The information and tools we provide are for
                    educational and organizational purposes only. For legal
                    matters regarding your insurance claim, including disputes
                    or litigation, you should consult with a licensed Florida
                    attorney who specializes in insurance law.
                  </AlertDescription>
                </Alert>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <Alert className="bg-blue-50 border-blue-200">
                  <AlertDescription className="text-sm text-gray-700">
                    Your insurance policy requires you to cooperate with your
                    insurance company's investigation of your claim. Using
                    ClaimGuardian does not change or eliminate these
                    obligations. You must continue to:
