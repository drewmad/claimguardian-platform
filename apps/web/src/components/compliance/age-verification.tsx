    ...
    <div className="space-y-3">
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          ...
          >
            <Calendar className="h-4 w-4 text-slate-400" />I confirm that I am
        ...
        >
          {calculateAge(dateOfBirth) >= 18 ? (
            <>
              <Check className="h-4 w-4" />
              <span>
                Age requirement met ({calculateAge(dateOfBirth)} years old)
              </span>
            </>
          ) : (
            <>
              <AlertCircle className="h-4 w-4" />
              <span>
                Must be 18 or older ({calculateAge(dateOfBirth)} years old)
              </span>
            </>
          )}
        </div>
