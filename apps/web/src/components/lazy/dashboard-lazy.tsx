...
export const LazyPropertiesPage = dynamic(
  () =>
    import("@/app/dashboard/properties/page").then((mod) => ({
      default: mod.default,
    })),
  {
...
export const LazyPropertyDetailPage = dynamic(
  () =>
    import("@/app/dashboard/property/[id]/page").then((mod) => ({
      default: mod.default,
    })),
  {
...
export const LazyPersonalPropertyPage = dynamic(
  () =>
    import("@/app/dashboard/personal-property/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingGrid />,
...
export const LazyClaimsPage = dynamic(
  () =>
    import("@/app/dashboard/claims/page").then((mod) => ({
      default: mod.default,
    })),
  {
...
export const LazyClaimDetailPage = dynamic(
  () =>
    import("@/app/dashboard/claims/[id]/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingCard />,
...
export const LazyInsurancePage = dynamic(
  () =>
    import("@/app/dashboard/insurance/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingGrid />,
...
export const LazyPoliciesPage = dynamic(
  () =>
    import("@/app/dashboard/policies/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingTable />,
...
export const LazyMaintenancePage = dynamic(
  () =>
    import("@/app/dashboard/maintenance/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingGrid />,
...
export const LazyHomeSystemsPage = dynamic(
  () =>
    import("@/app/dashboard/home-systems/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingGrid />,
...
export const LazyWarrantyWatchPage = dynamic(
  () =>
    import("@/app/dashboard/warranty-watch/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingTable />,
...
export const LazyCommunityPage = dynamic(
  () =>
    import("@/app/dashboard/community/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingGrid />,
...
export const LazyDisasterPage = dynamic(
  () =>
    import("@/app/dashboard/disaster/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingGrid />,
...
export const LazyContractorsPage = dynamic(
  () =>
    import("@/app/dashboard/contractors/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingTable />,
...
export const LazyAPIKeysPage = dynamic(
  () =>
    import("@/app/dashboard/api-keys/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingCard />,
...
export const LazyDamageAnalyzer = dynamic(
  () =>
    import("@/app/ai-tools/damage-analyzer/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingCard />,
...
export const LazyPolicyChat = dynamic(
  () =>
    import("@/app/ai-tools/policy-chat/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingCard />,
...
export const LazyInventoryScanner = dynamic(
  () =>
    import("@/app/ai-tools/inventory-scanner/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingGrid />,
...
export const LazyExpensesPage = dynamic(
  () =>
    import("@/app/dashboard/expenses/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingTable />,
...
export const LazyProfilePage = dynamic(
  () =>
    import("@/app/account/profile/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingCard />,
...
export const LazyLoginActivityPage = dynamic(
  () =>
    import("@/app/account/login-activity/page").then((mod) => ({
      default: mod.default,
    })),
  {
    loading: () => <DashboardLoadingTable />,
...
export const createLazyRoute = <P = Record<string, never>,>(
  ...
  return dynamic(importFn, {
    loading: () =>
      fallback ? React.createElement(fallback) : <DashboardLoadingCard />,
    ssr: false,
  });
};
...
export { DashboardLoadingCard, DashboardLoadingGrid, DashboardLoadingTable };
