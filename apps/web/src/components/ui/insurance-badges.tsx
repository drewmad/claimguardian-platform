...
export function PolicyStatusBadge({
  ...
  return (
    <InsuranceBadge variant={status}>
      {badgeConfig[status].label}
    </InsuranceBadge>
  );
}

export function InsurabilityBadge({
  level,
}: {
  ...
  return (
    <InsuranceBadge variant={variant}>
      {badgeConfig[variant].label}
    </InsuranceBadge>
  );
}
...
export function CoverageBadge({
  ...
  level: "adequate" | "partial" | "insufficient";
}) {
