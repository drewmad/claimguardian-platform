...
import { Card as BaseCard, CardContent as BaseCardContent, CardHeader as BaseCardHeader, CardTitle as BaseCardTitle, CardDescription as BaseCardDescription } from './card'
import React from 'react'

export type CardVariant = 'default' | 'insurance' | 'property' | 'claim' | 'elevated' | 'interactive' | 'danger'
...
const cardVariants = {
  ...
  interactive: 'bg-gray-800 border-gray-700 hover:bg-gray-700/50 transition-all duration-200 cursor-pointer',
...
export function CardDescription({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return <BaseCardDescription className={cn('text-gray-400', className)} {...props} />
}
