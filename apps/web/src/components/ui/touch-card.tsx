  ...
  "rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-200 touch-manipulation",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-transparent shadow-lg",
      },
      size: {
        default: "p-4",
        sm: "p-3",
...
export interface TouchCardProps
  extends Omit<React.HTMLAttributes<HTMLDivElement>, "children" | "onAnimationStart" | "onAnimationEnd" | "onDrag" | "onDragStart" | "onDragEnd" | "style">,
...
export const TouchCard = forwardRef<HTMLDivElement, TouchCardProps>(
  (
    ...
    const motionProps: MotionProps = {
      whileTap:
        interactive === "press" || interactive === "both"
          ? { scale: 0.98 }
          : undefined,
      whileHover:
        interactive === "hover" || interactive === "both"
          ? { y: -2 }
          : undefined,
