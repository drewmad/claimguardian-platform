        ...
        <div className="relative p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-400 mt-2">
              Sign in to access your ClaimGuardian account
            </p>
          </div>
                ...
                {error.code === "AUTH_EMAIL_NOT_VERIFIED" ? (
                  <div>
                    ...
                    <button
                      ...
                      disabled={
                        resending || resendSuccess || !email || isLimited
                      }
                    ...
                    error.message.includes("Invalid Refresh Token") ? (
                      <div className="mt-2">
                        <p className="text-xs text-red-300 mb-2">
                          This may be due to expired session cookies. Try
          ...
          <div className="mt-6 space-y-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-gradient-to-b from-slate-800 to-slate-900 px-2 text-slate-400">
                  New to ClaimGuardian?
                </span>
              </div>
            </div>
            <button
