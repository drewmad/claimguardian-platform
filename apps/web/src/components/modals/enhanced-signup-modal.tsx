...
export function EnhancedSignupModal() {
  ...
  const validateForm = () => {
    ...
    if (!formData.gdprConsent) {
      setValidationError('You must consent to data processing under GDPR')
      return false
    }
    return true
  }
  ...
  const handleResendEmail = async () => {
    ...
    try {
      ...
      logger.error('Unexpected error resending email', {}, err as Error)
    } finally {
      setResending(false)
    }
  }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-hidden">
