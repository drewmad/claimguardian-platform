...
export function SearchFilterBar({
  ...
  const toggleArrayFilter = (key: 'policyTypes' | 'carriers' | 'status', value: string) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {['Homeowners', 'Flood', 'Wind', 'Auto', 'Umbrella', 'Other'].map(type => (
                    <div key={type} className="flex items-center gap-2">
                      <Checkbox
                        id={`type-${type}`}
                        checked={filters.policyTypes.includes(type)}
                        onCheckedChange={() => toggleArrayFilter('policyTypes', type)}
                      />
                      <Label
                        htmlFor={`type-${type}`}
              ...
              <div>
                ...
                <div className="space-y-2 max-h-40 overflow-y-auto">
                  {availableCarriers.length > 0 ? (
                    availableCarriers.map(carrier => (
                      <div key={carrier} className="flex items-center gap-2">
                        <Checkbox
                          ...
                          onCheckedChange={() => toggleArrayFilter('carriers', carrier)}
                        />
                        <Label
                    ...
                    <p className="text-sm text-gray-400">No carriers available</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-700">
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  <Label htmlFor="date-start" className="text-sm text-gray-400">From</Label>
                  <Input
                    id="date-start"
                    type="date"
                ...
                <div className="flex-1">
                  <Label htmlFor="date-end" className="text-sm text-gray-400">To</Label>
                  <Input
                    id="date-end"
                    type="date"
