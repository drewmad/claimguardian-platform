      ...
      <div className="bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full border border-gray-700">
        <div className="p-6 border-b border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-white">Verify Property Address</h2>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
            <p className="text-sm text-gray-400 mb-2">Is this your correct address?</p>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gray-900/30 p-3 rounded-lg">
                  ...
                  <p className="text-sm text-white font-medium">{parsedAddress.street}</p>
                </div>
                <div className="bg-gray-900/30 p-3 rounded-lg">
                  <p className="text-xs text-gray-500">City</p>
                  <p className="text-sm text-white font-medium">{parsedAddress.city}</p>
                </div>
                <div className="bg-gray-900/30 p-3 rounded-lg">
                  <p className="text-xs text-gray-500">State</p>
                  <p className="text-sm text-white font-medium">{parsedAddress.state}</p>
                </div>
                <div className="bg-gray-900/30 p-3 rounded-lg">
                  <p className="text-xs text-gray-500">ZIP Code</p>
                  <p className="text-sm text-white font-medium">{parsedAddress.zipCode}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 p-3 rounded-lg flex items-start gap-2">
            ...
            <p className="text-xs text-yellow-300">
              Please verify this address is correct. This will be used for all property-related services and claims.
            </p>
          </div>
        </div>
