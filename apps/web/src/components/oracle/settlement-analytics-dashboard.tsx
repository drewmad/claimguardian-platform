...
export function SettlementAnalyticsDashboard() {
  ...
  const [selectedPrediction, setSelectedPrediction] =
    useState<SettlementPrediction | null>(null);
  ...
  const loadAnalytics = async () => {
    try {
      const analyticsData =
        await predictiveSettlementAnalyticsService.getSettlementAnalytics();
  ...
  const generatePrediction = async () => {
    if (
      !newPrediction.claim_id ||
      !newPrediction.estimated_damage ||
      !newPrediction.date_of_loss
    ) {
    ...
    try {
      ...
      const prediction =
        await predictiveSettlementAnalyticsService.generatePrediction(request);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">
              Oracle Settlement Analytics
            </h1>
            <p className="text-gray-400">
              ML-powered settlement prediction with market trend analysis
            </p>
          </div>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-400">
                    ${(analytics.average_predicted_amount / 1000).toFixed(0)}K
                  </p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p
                    className={`text-2xl font-bold flex items-center gap-1 ${analytics.market_performance.trend === "up" ? "text-green-400" : "text-red-400"}`}
                  >
                    ...
                    {analytics.market_performance.trend === "up" ? "+" : ""}
                    {(
                      ((analytics.market_performance.this_month -
                        analytics.market_performance.last_month) /
                        analytics.market_performance.last_month) *
                      100
                    ).toFixed(1)}
                    %
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                ...
                <CardDescription>
                  {predictions.length} settlement prediction
                  {predictions.length !== 1 ? "s" : ""} generated
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {predictions.map((prediction) => (
                    ...
                    >
                      ...
                      <div className="mt-2 text-xs text-gray-500">
                        Range: ${prediction.amount_range.low.toLocaleString()} -
                        ${prediction.amount_range.high.toLocaleString()}
                      </div>
                    </div>
                  ))}
                  ...
                  {predictions.length === 0 && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-sm text-gray-500">
                        Create your first settlement prediction
                      </p>
                    </div>
                  )}
                </div>
            ...
            {selectedPrediction ? (
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center p-4 bg-purple-900/20 rounded-lg border border-purple-700/30">
                    ...
                    <p className="text-sm text-gray-400 mt-2">
                      Range: $
                      {selectedPrediction.amount_range.low.toLocaleString()} - $
                      {selectedPrediction.amount_range.high.toLocaleString()}
                    </p>
                    <Badge
                      className={getConfidenceColor(
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 mb-3">
                      ...
                      <span className="text-blue-400 font-medium">
                        {selectedPrediction.timeline_prediction.estimated_days}{" "}
                        days
                      </span>
                    </p>
                    ...
                    <div className="space-y-2">
                      {Object.entries(
                        selectedPrediction.timeline_prediction
                          .probability_by_timeframe,
                      ).map(([timeframe, probability]) => (
                        <div
                          key={timeframe}
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {selectedPrediction.success_factors.map(
                        (factor, index) => (
                          <div
                            key={index}
                            className="p-2 bg-green-900/10 border border-green-900/20 rounded"
                          >
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedPrediction.risk_factors.map((risk, index) => (
                          <div
                            key={index}
                            className="p-2 bg-orange-900/10 border border-orange-900/20 rounded"
                          >
                            <div className="flex items-center justify-between mb-1">
                                ...
                                className={`text-xs ${
                                  risk.severity === "high"
                                    ...
                                    : risk.severity === "medium"
                                      ? "bg-orange-900/20 text-orange-400 border-orange-600/30"
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-gray-400">
                    Select a prediction from the list to view detailed analysis
                  </p>
                </CardContent>
              </Card>
            )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent>
                {analytics && (
                  <div className="space-y-3">
                    {Object.entries(analytics.success_rate_by_factor).map(
                      ([factor, rate]) => (
                        <div
                          key={factor}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-purple-400 font-medium">
                        $
                        {(analytics.average_predicted_amount / 1000).toFixed(0)}
                        K vs $
                        {(analytics.average_actual_amount / 1000).toFixed(0)}K
                      </span>
                    </div>
        ...
        <TabsContent value="generate" className="space-y-4">
          ...
          <Card className="bg-gray-800 border-gray-700 max-w-4xl">
            <CardHeader>
              ...
              <CardDescription>
                Provide claim details to generate an AI-powered settlement
                prediction
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setNewPrediction({ ...newPrediction, county: value })
                      }
                    >
                      <SelectTrigger className="bg-gray-700 border-gray-600 text-white">
                        <SelectValue />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewPrediction({
                          ...newPrediction,
                          estimated_damage: parseInt(e.target.value) || 0,
                        })
                      }
                      placeholder="75000"
                      className="bg-gray-700 border-gray-600 text-white"
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewPrediction({
                          ...newPrediction,
                          policy_limits: parseInt(e.target.value) || 0,
                        })
                      }
                      placeholder="500000"
                      className="bg-gray-700 border-gray-600 text-white"
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewPrediction({
                          ...newPrediction,
                          deductible: parseInt(e.target.value) || 0,
                        })
                      }
                      placeholder="2500"
                      className="bg-gray-700 border-gray-600 text-white"
                ...
                <div className="flex items-center space-x-2 pt-8">
                  <input
                    ...
                    onChange={(e) =>
                      setNewPrediction({
                        ...newPrediction,
                        legal_representation: e.target.checked,
                      })
                    }
