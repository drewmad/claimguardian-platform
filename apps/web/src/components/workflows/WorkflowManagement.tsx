...
const workflowTemplates: Workflow[] = [
  {
    ...
    description:
      "Automatically collect and analyze documentation when a new claim is created",
    status: "active",
  ...
  },
  {
    ...
    description:
      "Activate emergency procedures when severe weather is detected",
    status: "inactive",
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="all" className="space-y-4">
        ...
        {["all", "claim", "property", "maintenance", "communication"].map(
          (tab) => (
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="claim.created">
                    When claim is created
                  </SelectItem>
                  <SelectItem value="claim.updated">
                    When claim is updated
                  </SelectItem>
                  <SelectItem value="property.added">
