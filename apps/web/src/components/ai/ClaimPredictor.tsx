...
export function ClaimPredictor() {
  ...
  const analyzeClaim = async () => {
    ...
    try {
      ...
      if (formData.hasPhotos && formData.hasContractorEstimate)
        settlementDays -= 10;
      ...
      const payout =
        payoutRanges[formData.severity as keyof typeof payoutRanges] ||
        payoutRanges.moderate;
      ...
      if (formData.timeFromIncident > 14) {
        riskFactors.push({
          ...
          mitigation:
            "Provide explanation for delay and any interim mitigation efforts",
        });
      }
      ...
      if (formData.previousClaims > 2) {
        riskFactors.push({
          ...
          impact: "medium",
          description:
            "History of frequent claims may trigger additional scrutiny",
  ...
  const getLikelihoodBadge = (score: number) => {
    if (score >= 75)
      return <Badge className="bg-green-500">High Approval Chance</Badge>;
    if (score >= 50)
      return <Badge className="bg-yellow-500">Moderate Approval Chance</Badge>;
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Get instant predictions on claim approval likelihood and
            recommendations
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, insuranceCarrier: value })
                }
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    timeFromIncident: parseInt(e.target.value),
                  })
                }
              />
            </div>
                ...
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        hasContractorEstimate: e.target.checked,
                      })
                    }
                  />
                ...
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        hasPoliceReport: e.target.checked,
                      })
                    }
                  />
            ...
            <div className="md:col-span-2">
              <Button
                ...
                disabled={
                  analyzing || !formData.damageType || !formData.severity
                }
                className="w-full"
              >
                {analyzing ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <TrendingUp
                    className={`h-8 w-8 ${getLikelihoodColor(prediction.approvalLikelihood)}`}
                  />
                ...
                <Progress
                  value={prediction.approvalLikelihood}
                  className="mt-3"
                />
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div>
                  <p className="text-3xl font-bold">
                    {prediction.estimatedSettlementDays}
                  </p>
                  <p className="text-sm text-gray-500">Days to Settlement</p>
                </div>
                <p className="text-xs text-gray-400 mt-2">
                  Industry avg:{" "}
                  {prediction.similarClaimsAnalysis.avgSettlementDays} days
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Range: ${prediction.estimatedPayout.min.toLocaleString()} - $
                  {prediction.estimatedPayout.max.toLocaleString()}
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <TabsContent value="improvements">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Actions to increase your approval chances and speed up
                    processing
                  </CardDescription>
                </CardHeader>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center mt-2">
                            <Progress
                              value={improvement.estimatedImpact}
            ...
            <TabsContent value="risks">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Issues that may affect your claim approval or processing
                    time
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
            ...
            <TabsContent value="similar">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Based on{" "}
                    {prediction.similarClaimsAnalysis.totalAnalyzed.toLocaleString()}{" "}
                    similar claims in your area
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <Alert className="mt-4">
                    ...
                    <AlertDescription>
                      This analysis is based on anonymized claim data from
                      similar properties with{" "}
                      {formData.damageType.replace("_", " ")} damage of{" "}
                      {formData.severity} severity in Florida over the past 12
                      months.
                    </AlertDescription>
                  </Alert>
                </CardContent>
            ...
            <TabsContent value="timeline">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Expected progression of your claim based on current
                    documentation
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500">
                          Days 21-{prediction.estimatedSettlementDays}
                        </p>
                      </div>
                    </div>
                  </div>
