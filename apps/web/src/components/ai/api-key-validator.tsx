          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-amber-200 mb-4">
                This AI tool requires API keys to function. Please configure the
                required providers:
              </p>
              ...
              <div className="space-y-2 mb-6">
                {needsOpenAI && (
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-2 h-2 rounded-full ${hasOpenAI ? "bg-green-400" : "bg-red-400"}`}
                    />
                ...
                {needsGemini && (
                  <div className="flex items-center gap-2">
                    <div
                      className={`w-2 h-2 rounded-full ${hasGemini ? "bg-green-400" : "bg-red-400"}`}
                    />
                    <span className="text-sm text-gray-300">
                      Google Gemini API Key{" "}
                      {hasGemini ? "(Configured)" : "(Required)"}
                    </span>
                  </div>
                )}
              </div>
