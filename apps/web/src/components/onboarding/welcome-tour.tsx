...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    content:
      "Let me show you around your property management dashboard. This quick tour will help you get started.",
    target: "body",
    position: "bottom",
    icon: Sparkles,
  },
  {
    ...
    content:
      "Track your property's current value and see year-over-year changes. Click here to view detailed property information.",
  ...
  },
  {
    ...
    content:
      "Keep track of all your valuable items. Document everything from electronics to jewelry for insurance purposes.",
  ...
  },
  {
    ...
    content:
      "See at a glance how well your property is protected. We analyze your coverage and highlight any gaps.",
  ...
  },
  {
    ...
    content:
      "Never miss important maintenance or insurance deadlines. We'll remind you when action is needed.",
  ...
  },
  {
    ...
    content:
      "Get real-time weather alerts and prepare for severe conditions. Especially important during hurricane season!",
  ...
  },
  {
    ...
    content:
      "Our AI analyzes your property data and provides personalized recommendations to protect your investment.",
  ...
  },
  {
    ...
    content:
      "Jump to any feature quickly. From claims management to contractor connections, everything is just a click away.",
  ...
  },
  {
    ...
    content:
      "That's the basics! Explore the dashboard and discover more features. Need help? Click the learning assistant in the corner.",
    target: "body",
    position: "bottom",
    icon: CheckCircle,
  },
...
export function WelcomeTour({
  ...
  const calculatePosition = useCallback(
    (element: HTMLElement, position: string): TooltipPosition => {
  ...
  const handleNext = () => {
    if (currentStep < TOUR_STEPS.length - 1) {
      ...
      logger.track("onboarding_tour_step", {
        step: TOUR_STEPS[currentStep + 1].id,
      });
    } else {
      handleComplete();
    }
  ...
  const handlePrevious = () => {
    if (currentStep > 0) {
      setCurrentStep(currentStep - 1);
      logger.track("onboarding_tour_step_back", {
        step: TOUR_STEPS[currentStep - 1].id,
      });
    }
  };
