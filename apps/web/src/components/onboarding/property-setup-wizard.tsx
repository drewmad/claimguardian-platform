...
export function PropertySetupWizard({
  ...
  const handleNext = () => {
    ...
    if (currentStep < WIZARD_STEPS.length - 1) {
      ...
      logger.track("property_wizard_step", {
        step: WIZARD_STEPS[currentStep + 1].id,
      });
    } else {
      handleSubmit();
    }
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFieldChange("squareFootage", e.target.value)
                  }
                  className={`bg-gray-700 border-gray-600 ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFieldChange("estimatedValue", e.target.value)
                  }
              ...
              <div className="p-4 bg-gray-700/50 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg font-semibold text-green-400">
                    +$
                    {(
                      parseFloat(propertyData.estimatedValue) -
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleFieldChange("insuranceCarrier", e.target.value)
                }
                className={`bg-gray-700 border-gray-600 ${
                  errors.insuranceCarrier && touched.insuranceCarrier
                    ? "border-red-500"
                    : ""
                }`}
              />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleFieldChange("coverageAmount", e.target.value)
                  }
                  className={`bg-gray-700 border-gray-600 pl-8 ${
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-lg font-semibold ${
                      parseFloat(propertyData.coverageAmount) >=
                      parseFloat(propertyData.estimatedValue)
                        ? "text-green-400"
                        : "text-yellow-400"
                    }`}
            ...
            <div className="p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Upload photos to document your property's condition and
                    insurance policies for quick reference during claims.
                  </p>
                </div>
              </div>
            </div>
