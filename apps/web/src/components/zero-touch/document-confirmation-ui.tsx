...
export function DocumentConfirmationUI() {
  ...
  async function loadPendingDocuments() {
    try {
      ...
      const { data: pendingDocs, error } = await supabase.rpc(
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    {getConfidenceBadge(
                      doc.ai_confidence_scores?.overall || 0.8,
                    )}
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-gray-900 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-400">
                {doc.ai_reasoning ||
                  "AI analysis completed with multi-provider consensus"}
              </p>
            </div>
            ...
            <div className="space-y-3">
              {editingDoc === doc.id ? (
                ...
                <>
                  ...
                  {/* Extracted Metadata */}
                  {doc.ai_extracted_metadata &&
                    Object.keys(doc.ai_extracted_metadata).length > 0 && (
                      <div>
                        <span className="text-sm text-gray-400 block mb-2">
