          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                All data is anonymized and aggregated. Your personal information
                is never shared.
              </p>
            </div>
          </div>
      ...
      {showPrivacyInfo && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Choose what anonymous data you're comfortable sharing with the
              community
            </CardDescription>
          </CardHeader>
            ...
            {Object.entries(privacySettings).map(([key, value]) => (
              <div key={key} className="flex items-center justify-between">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    togglePrivacySetting(key as keyof PrivacySettings)
                  }
                >
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      Wind damage claims typically increase 40% in your area
                      during hurricane season (June-November). Consider
                      reviewing your coverage before June.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 mt-1">
                      Claims with complete photo documentation settle 62% faster
                      in your area. Average settlement time: 14 days vs 36 days.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      78% of roof damage claims in your neighborhood could be
                      prevented with annual inspections. Schedule your free
                      inspection today.
                    </p>
                  </div>
                </div>
