...
export function NotificationProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const savedNotifications = localStorage.getItem('claimguardian-notifications')
  ...
  useEffect(() => {
    localStorage.setItem('claimguardian-notifications', JSON.stringify(notifications))
  }, [notifications])
  ...
  const addNotification = (notificationData: Omit<PersistentNotification, 'id' | 'timestamp'>) => {
...
export function NotificationCenter() {
  ...
  const [selectedType, setSelectedType] = useState<PersistentNotification['type'] | 'all'>('all')
  ...
  const getTypeColor = (type: PersistentNotification['type']) => {
    switch (type) {
      ...
      case 'property': return 'text-emerald-600'
    ...
    <div className="max-h-[600px] flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-400 mb-3">
          ...
          {stats.urgent > 0 && (
            <span className="text-red-600 dark:text-red-400">{stats.urgent} urgent</span>
          )}
        </div>
    ...
    >
      <div className="flex items-start space-x-3">
        <div className={cn(
          ...
          !notification.read ? "bg-blue-100 dark:bg-blue-900/20" : "bg-gray-100 dark:bg-gray-800"
        )}>
                  ...
                  {notification.actions.map((action) => (
                    <Button
                      ...
                      variant={
                        ...
                        action.type === 'secondary' ? 'outline' : 'default'
                      }
                      size="sm"
