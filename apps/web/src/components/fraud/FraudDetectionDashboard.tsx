      ...
      indicators: [
        {
          ...
          evidence: ['Photo metadata altered', 'Photoshop traces found', 'Lighting inconsistencies'],
          confidence: 92
        },
        {
          id: '2',
        ...
        },
        {
          ...
          evidence: ['Same damage type', 'Related parties', 'Sequential timing'],
          confidence: 85
        }
      ]
    },
      ...
      indicators: [
        {
          ...
          evidence: ['8 claims in 3 months', 'All high-value', 'Same estimator'],
          confidence: 71
        },
        {
          id: '5',
      ...
      indicators: [
        {
          ...
          evidence: ['Weather-related', 'Different properties', 'Documented storms'],
          confidence: 45
        }
      ]
    }
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">{metrics.totalScreened.toLocaleString()}</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">${(metrics.savedAmount / 1000000).toFixed(1)}M</p>
                  ...
                  <div key={alert.id} className="border rounded-lg p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="text-right">
                        <p className={`text-3xl font-bold ${getRiskColor(alert.riskScore)}`}>
                          {alert.riskScore}%
                        </p>
                        <p className="text-xs text-gray-500">Risk Score</p>
                      </div>
                    ...
                    <div className="space-y-2">
                      {alert.indicators.map((indicator) => (
                        <div key={indicator.id} className="flex items-start space-x-2 p-2 bg-gray-50 rounded">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Distribution of detected fraud types</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
        ...
        <TabsContent value="network">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Connections between suspicious claims, contractors, and addresses
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px] flex items-center justify-center bg-gray-50 rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500">
                    Visualizes relationships between claims, parties, and contractors
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={fraudTrends}>
                  ...
                  <Line type="monotone" dataKey="prevented" stroke="#22c55e" name="Prevented" />
                  <Line type="monotone" dataKey="falsePositive" stroke="#3b82f6" name="False Positives" />
                </LineChart>
              </ResponsiveContainer>
