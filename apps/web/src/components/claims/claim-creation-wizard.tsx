  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      ...
      case 1: // Property & Location
        if (
          !claimData.propertyAddress ||
          claimData.damageLocation?.length === 0
        ) {
          ...
          <div className="space-y-6">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateClaimData({ damageType: value })
                }
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateClaimData({ dateOfLoss: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateClaimData({ timeOfLoss: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateClaimData({ discoveredDate: e.target.value })
                }
                max={new Date().toISOString().split("T")[0]}
              />
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateClaimData({ propertyAddress: e.target.value })
                }
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateClaimData({ causeOfLoss: e.target.value })
                }
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updateClaimData({ immediateActions: e.target.value })
                }
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) =>
                    updateClaimData({ emergencyRepairs: e.target.checked })
                  }
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateClaimData({ policyNumber: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateClaimData({ insuranceCompany: e.target.value })
                  }
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) =>
                    updateClaimData({ reportedToInsurance: e.target.checked })
                  }
                  className="rounded border-gray-600"
                />
                <span>
                  I have already reported this to my insurance company
                </span>
              </label>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateClaimData({ reportedDate: e.target.value })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateClaimData({ claimNumber: e.target.value })
                        }
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <Input
                        ...
                        onChange={(e) =>
                          updateClaimData({ adjusterName: e.target.value })
                        }
                      />
                      <Input
                        ...
                        onChange={(e) =>
                          updateClaimData({ adjusterPhone: e.target.value })
                        }
                      />
                      <Input
                        ...
                        onChange={(e) =>
                          updateClaimData({ adjusterEmail: e.target.value })
                        }
                      />
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            <div className="bg-blue-600/20 border border-blue-600 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-400">
                Upload all evidence to support your claim. You can add more
                files later from the claim details page.
              </p>
            </div>
              ...
              <div className="pt-4 border-t border-gray-700 grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-medium">
                    {claimData.photos?.length || 0} uploaded
                  </p>
                </div>
                <div>
                  <span className="text-gray-400">Documents:</span>
                  <p className="font-medium">
                    {claimData.documents?.length || 0} uploaded
                  </p>
                </div>
              </div>
            </div>
