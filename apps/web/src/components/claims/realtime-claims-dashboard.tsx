...
export function RealtimeClaimsDashboard({
  className,
}: RealtimeClaimsDashboardProps) {
  ...
  const calculateSlaStatus = (deadline: string) => {
    ...
    if (hoursRemaining < 0)
      return { status: "overdue", color: "text-red-500", icon: AlertTriangle };
    if (hoursRemaining < 2)
      return { status: "critical", color: "text-orange-500", icon: Clock };
      ...
      <div className={`space-y-6 ${className}`}>
        <div className="flex items-center justify-center p-12">
          ...
          <span className="ml-2 text-gray-400">
            Loading claims processing data...
          </span>
        </div>
      </div>
    );
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">
                    {metrics.total_claims_today}
                  </p>
                  <p className="text-xs text-green-400">
                    +{metrics.processed_claims_today} processed
                  </p>
                </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-400">
                          <div>
                            ...
                            <p>
                              {item.processing_metadata.complexity_score.toFixed(
                                1,
                              )}
                              /10
                            </p>
                          ...
                          <div>
                            ...
                            <p>
                              {item.processing_metadata.estimated_duration_hours.toFixed(
                                1,
                              )}
                              h
                            </p>
                          ...
                          <div>
                            ...
                            <p
                              className={`flex items-center ${slaStatus.color}`}
                            >
                        ...
                        {item.processing_metadata.required_expertise.length >
                          0 && (
                          <div className="mt-2">
                            ...
                            <div className="flex flex-wrap gap-1">
                              {item.processing_metadata.required_expertise.map(
                                (skill, idx) => (
                                  <Badge
                                    key={idx}
                                    variant="secondary"
              ...
              {processingQueue.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400">
                    No claims currently in the processing queue.
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent className="space-y-3 max-h-96 overflow-y-auto">
              {recentEvents.map((event) => (
                <div
                  key={event.id}
                  className="flex items-start space-x-3 p-3 border border-gray-700 rounded-lg"
                >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        {event.automated && (
                          <Badge
                            variant="secondary"
                            className="text-xs bg-cyan-600/20 text-cyan-400"
                          >
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-3">
                    {Object.entries(metrics.priority_breakdown).map(
                      ([priority, count]) => (
                        <div
                          key={priority}
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-20 bg-gray-700 rounded-full h-2">
                              <div
                                ...
                                style={{
                                  width: `${(count / Math.max(...Object.values(metrics.priority_breakdown))) * 100}%`,
                                }}
                              />
                            </div>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-3">
                    {Object.entries(metrics.processing_stages).map(
                      ([stage, count]) => (
                        <div
                          key={stage}
                          className="flex items-center justify-between"
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-20 bg-gray-700 rounded-full h-2">
                              <div
                                ...
                                style={{
                                  width: `${(count / Math.max(...Object.values(metrics.processing_stages))) * 100}%`,
                                }}
                              />
                            </div>
                            <span className="text-white font-medium w-8">
