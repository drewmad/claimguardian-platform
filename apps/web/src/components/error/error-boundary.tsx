...
> {
  ...
  render() {
    ...
    if (hasError) {
      ...
      return (
        <DefaultErrorFallback {...fallbackProps} maxRetries={maxRetries} />
      );
    }
    ...
    <AnimatePresence>
      <motion.div
        ...
        className={cn("flex items-center justify-center p-4", {
          "min-h-screen bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20":
            isPageLevel || isCritical,
          "h-full": !isPageLevel && !isCritical,
        })}
      >
        <Card
          className={cn("w-full max-w-lg border-red-200 dark:border-red-800", {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center pt-2 border-t border-gray-200 dark:border-gray-700">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "mailto:support@claimguardianai.com?subject=Error Report&body=Error ID: " +
                      errorId,
                  )
                }
                className="text-gray-600 hover:text-gray-800"
