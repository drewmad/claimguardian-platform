...
describe("MultiStepSignupForm", () => {
  ...
  describe("Welcome Step", () => {
    it("should render welcome step initially", () => {
      ...
      (
        expect(screen.getByText("Welcome to ClaimGuardian")) as any
      ).toBeInTheDocument();
      (
        expect(screen.getByText(/AI-powered insurance claim advocate/)) as any
      ).toBeInTheDocument();
  ...
  describe("Account Step", () => {
    ...
    it("should render all form fields", () => {
      ...
      (
        expect(screen.getByLabelText(/Phone Number/)) as any
      ).toBeInTheDocument();
      (expect(screen.getByLabelText(/Password/)) as any).toBeInTheDocument();
      (
        expect(screen.getByLabelText(/Confirm Password/)) as any
      ).toBeInTheDocument();
    });
    ...
    it("should validate email format", async () => {
      ...
      (
        expect(screen.getByText("Please enter a valid email")) as any
      ).toBeInTheDocument();
    });
    ...
    it("should validate password confirmation", async () => {
      ...
      (
        expect(screen.getByText(/Passwords don't match/)) as any
      ).toBeInTheDocument();
    });
  ...
  describe("Legal Step", () => {
    ...
    it("should render legal agreements", () => {
      ...
      (
        expect(screen.getByText(/I confirm that I am 18 years or older/)) as any
      ).toBeInTheDocument();
  ...
  describe("AI Disclaimer Step", () => {
    ...
    it("should render AI disclaimer content", () => {
      ...
      (
        expect(screen.getByText(/AI can make mistakes/)) as any
      ).toBeInTheDocument();
      (
        expect(screen.getByText(/verify important information/)) as any
      ).toBeInTheDocument();
    });
  ...
  describe("Form Submission", () => {
    ...
    it("should redirect to onboarding on successful signup", async () => {
      ...
      await waitFor(() => {
        (expect(mockRouter.push) as any).toHaveBeenCalledWith(
    ...
    it("should show error message on signup failure", async () => {
      ...
      await waitFor(() => {
        (
          expect(screen.getByText("Email already registered")) as any
        ).toBeInTheDocument();
      });
    });
    ...
    it("should show loading state during submission", async () => {
      ...
      await user.click(screen.getByText("Create Account"));
      (
        expect(screen.getByText("Creating Account...")) as any
      ).toBeInTheDocument();
    });
  });
