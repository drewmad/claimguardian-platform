...
const faqs = [
  ...
  },
  {
    ...
    answer: "Your property data is YOUR private information, protected with bank-level encryption. You decide what to share, when to share it, and with whom. We never sell to third parties and develop AI in-house to ensure complete privacy. Community insights are anonymized - your specific data stays yours."
  }
]
    ...
    <section id="faq" className="py-16 md:py-24">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-4">
          ...
          <span className="block mt-2 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">Questions Answered</span>
        </h2>
