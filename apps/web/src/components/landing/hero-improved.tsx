            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 text-left">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  Built by Florida Families, 
                  <span className="block text-green-400">for Florida Families</span>
                </h2>
                <p className="text-lg text-gray-300 mb-6">
                  We understand hurricane seasons, flood zones, and what it's like to fight insurance companies. 
                  Our team has lived through Florida's weather challenges and built ClaimGuardian to help fellow homeowners.
                </p>
                <div className="flex items-center gap-4 text-sm text-gray-400">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Port Charlotte Based</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
              ...
              {/* Photo placeholder - perfect spot for baby coding photo */}
              <div className="flex-shrink-0 w-80 h-64 bg-gradient-to-br from-gray-800/70 to-gray-900/70 backdrop-blur-xl border border-gray-700/50 rounded-2xl flex items-center justify-center shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                <div className="text-center text-gray-400">
                  <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-blue-600/30 to-green-600/20 rounded-xl flex items-center justify-center">
