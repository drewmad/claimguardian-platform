...
const GuardianShieldIcon = () => (
  <svg
    ...
    className="drop-shadow-[0_8px_32px_rgba(91,163,245,0.4)] h-16 md:h-20 w-auto"
  >
    <path
      d="M32 0L2.78461 12V36C2.78461 52.8 15.2462 68.4 32 72C48.7538 68.4 61.2154 52.8 61.2154 36V12L32 0Z"
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-[#0a0e1a]">
        ...
        <style jsx>{`
          ...
          .aurora-3 {
            ...
            right: 10%;
            background: ${COLORS.primary};
            animation: aurora-3 20s infinite alternate;
          }
          .aurora-4 {
            width: 30vw;
            height: 30vw;
            ...
            right: 20%;
            background: ${COLORS.accent};
            animation: aurora-4 35s infinite alternate;
          }
          ...
          @keyframes aurora-4 {
            ...
            100% {
              transform: translate(30%, -80%) scale(1.2);
              opacity: 0.15;
            }
          }
        `}</style>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center pt-16 pb-24">
          ...
          <AnimatedSection delay={300}>
            <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-300 leading-relaxed">
              ClaimGuardian guards everything you own, rent, or manage—including
              that boat you've used twice since buying it. Your personal AI{" "}
              <span className="font-semibold text-primary/90">Guardian</span>{" "}
              documents your stuff (even the manatee mailbox), tracks when your
              AC needs its monthly blessing, and maximizes claims when frozen
              iguanas damage your roof or love bugs cause $2,000 in paint
              damage.{" "}
              <span className="italic text-primary/80">
                Because Florida's gonna Florida
              </span>
              , but with{" "}
              <span className="font-semibold text-primary/90">Guardian</span>{" "}
              watching over you, your assets don't have to suffer.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={500}>
            <div className="mt-12 flex flex-wrap gap-3 justify-center">
              {pills.map((pill) => (
                <div
                  key={pill.label}
                  className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/[.03] backdrop-blur-sm transition-colors hover:bg-white/10"
                >
        ...
        <AnimatedSection>
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                <h3 className="font-slab text-4xl font-bold text-primary">
                  15 Minutes
                </h3>
                <p className="mt-1 text-gray-300">
                  To setup your property's digital twin.
                </p>
              </div>
              <div>
                <h3 className="font-slab text-4xl font-bold text-primary">
                ...
                <p className="mt-1 text-gray-300">
                  To capture & value personal property.
                </p>
              </div>
              <div>
                <h3 className="font-slab text-4xl font-bold text-primary">
                ...
                <p className="mt-1 text-gray-300">
                  To capture a full damage assessment.
                </p>
              </div>
            </div>
          </div>
