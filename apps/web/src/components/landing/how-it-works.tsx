...
const steps = [
  {
    ...
    title: "15-Min Setup",
    description:
      "Snap photos, upload your policy. AI instantly creates your property's digital twin. Zero paperwork, maximum protection.",
    time: "15 minutes",
  ...
  },
  {
    ...
    description:
      "Your digital twin monitors everything: maintenance schedules, weather threats, coverage gaps. You sleep, we watch.",
    time: "Always on",
  ...
  },
  {
    ...
    description:
      "Damage happens? AI generates professional reports, estimates, and evidence packages in minutes, not weeks.",
  ...
  },
  {
    ...
    description:
      "Get every dollar you deserve. Our AI finds hidden damages and fights for proper settlements. No money left behind.",
    ...
    <section id="how-it-works" className="px-4 md:px-8 py-20 bg-[#0a0e1a]">
      <AnimatedSection className="max-w-6xl mx-auto">
        <h2 className="font-slab text-3xl md:text-4xl font-bold text-center">
          ...
          <span className="block mt-2 text-2xl md:text-3xl bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">
            in 4 Simple Steps
          </span>
        </h2>
        <p className="mt-6 max-w-3xl mx-auto text-center text-xl text-gray-300">
          Transform your property from a liability into your most protected
          asset. No technical skills required.
        </p>
        <div className="mt-12 relative flex flex-col md:flex-row justify-between items-center">
          ...
          {steps.map((step, index) => (
            <AnimatedSection
              key={index}
              delay={index * 150}
              className="relative z-10 flex md:flex-col items-start md:items-center text-left md:text-center w-full md:w-1/4 p-4"
            >
