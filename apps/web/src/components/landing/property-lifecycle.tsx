...
import { Home, Shield, TrendingUp, Clock, Wrench, FileText, AlertTriangle, Building } from 'lucide-react'
...
export function PropertyLifecycle() {
  const [activePhase, setActivePhase] = useState<'buy' | 'own' | 'crisis' | 'legacy'>('buy')
        ...
        <AnimatedSection delay={200}>
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-400 text-sm mt-1">Property setup time</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-blue-400">$12K+</div>
              <div className="text-gray-400 text-sm mt-1">Avg. savings per year</div>
            </div>
            <div>
