...
export class SemanticSimilarityService {
  ...
  async findSimilar(
    ...
    throw new Error(
      "Semantic similarity requires Opus model. Implementation pending.",
    );
  }
  ...
  async generateEmbedding(
    item: Learning | Pattern | string,
  ): Promise<number[]> {
    // TODO: Implement embedding generation
    throw new Error(
      "Embedding generation requires Opus model. Implementation pending.",
    );
  }
  ...
  async calculateSimilarity(
    ...
    throw new Error(
      "Similarity calculation requires Opus model. Implementation pending.",
    );
  }
  ...
  async findApplicablePatterns(
    ...
    throw new Error(
      "Pattern matching requires Opus model. Implementation pending.",
    );
  }
   ...
   */
  async detectDuplicates(learnings: Learning[]): Promise<DuplicateGroup[]> {
    // TODO: Implement duplicate detection
    throw new Error(
      "Duplicate detection requires Opus model. Implementation pending.",
    );
  }
   ...
   */
  async suggestMerges(learnings: Learning[]): Promise<MergeSuggestion[]> {
    // TODO: Implement merge suggestions
    throw new Error(
      "Merge suggestions require Opus model. Implementation pending.",
    );
  }
