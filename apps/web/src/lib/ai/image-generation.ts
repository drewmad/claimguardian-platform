...
export function getPropertyImagePrompt(
  options: PropertyImageOptions = {},
): string {
  const {
  ...
  const basePrompts = {
    "modern-home":
      "A modern, sleek single-family home with clean lines, large windows, and contemporary architecture",
    "traditional-home":
      "A classic traditional home with timeless architectural details, pitched roof, and welcoming front porch",
    "florida-style":
      "A beautiful Florida-style home with Mediterranean influences, tile roof, palm trees, and tropical landscaping",
    "coastal-home":
      "A stunning coastal home with wraparound porches, nautical elements, and ocean-inspired design",
    "suburban-home":
      "A charming suburban family home with manicured lawn, driveway, and neighborhood setting",
    "luxury-home":
      "An elegant luxury home with premium materials, sophisticated design, and upscale landscaping",
    "condo-building":
      "A modern condominium building with multiple units, balconies, and contemporary facade",
    townhouse:
      "A stylish townhouse with attached units, individual entrances, and urban design",
  };
  ...
  if (location.toLowerCase().includes("florida")) {
    prompt +=
      ", situated in sunny Florida with palm trees and tropical vegetation";
  }
  ...
  prompt +=
    ", professional real estate photography style, bright natural lighting, clear blue sky, well-maintained property, high quality, 4K resolution, architectural photography";
