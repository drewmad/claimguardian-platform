...
export const claimGuardianE2ETests: E2ETestCase[] = [
  {
    ...
    description:
      "Test complete property creation workflow from start to finish",
    ...
    steps: [
      ...
      {
        action: "expect",
        element: "property-wizard-screen",
        assertion: { type: "visible" },
      },
      ...
      {
        action: "expect",
        element: "property-detail-screen",
        assertion: { type: "visible" },
      },
    ],
    teardown: [
...

  {
    ...
    steps: [
      ...
      {
        action: "type",
        element: "assessment-title-input",
        text: "Roof Damage Assessment",
      },
      { action: "tap", element: "property-selector" },
      { action: "tap", element: "test-property-option" },
      {
        action: "type",
        element: "damage-description-input",
        text: "Storm damage to shingles and gutters",
      },
      { action: "tap", element: "next-button" },
      ...
      {
        action: "expect",
        element: "assessment-success",
        assertion: { type: "visible" },
      },
      {
        action: "expect",
        element: "assessment-detail-screen",
        assertion: { type: "visible" },
      },
    ],
  },

  {
    ...
    description:
      "Test offline data creation and synchronization when back online",
    ...
    steps: [
      ...
      {
        action: "type",
        element: "property-name-input",
        text: "Offline Test Property",
      },
      { action: "tap", element: "save-offline-button" },
      {
        action: "expect",
        element: "offline-saved-indicator",
        assertion: { type: "visible" },
      },
      ...
      {
        action: "expect",
        element: "offline-queue-indicator",
        assertion: { type: "visible" },
      },
      ...
      {
        action: "expect",
        element: "sync-in-progress",
        assertion: { type: "visible" },
      },
      { action: "wait", duration: 5000 },
      {
        action: "expect",
        element: "sync-complete",
        assertion: { type: "visible" },
      },
      ...
      {
        action: "expect",
        element: "offline-test-property",
        assertion: { type: "visible" },
      },
      { action: "tap", element: "assessments-tab" },
      {
        action: "expect",
        element: "offline-assessment",
        assertion: { type: "visible" },
      },
    ],
  },

  {
    ...
    steps: [
      ...
      {
        action: "type",
        element: "photo-title-input",
        text: "Roof Damage Photo",
      },
      {
        action: "type",
        element: "photo-description-input",
        text: "Missing shingles on east side",
      },
      { action: "tap", element: "property-selector" },
      { action: "tap", element: "test-property-option" },
      ...
      {
        action: "expect",
        element: "ai-analysis-loading",
        assertion: { type: "visible" },
      },
      { action: "wait", duration: 10000 },
      {
        action: "expect",
        element: "ai-analysis-results",
        assertion: { type: "visible" },
      },
      ...
      {
        action: "expect",
        element: "damage-type-result",
        assertion: { type: "visible" },
      },
      {
        action: "expect",
        element: "severity-rating",
        assertion: { type: "visible" },
      },
      {
        action: "expect",
      ...
      {
        action: "expect",
        element: "analysis-saved-message",
        assertion: { type: "visible" },
      },
...

  {
    ...
    description:
      "Test app performance with large datasets and multiple operations",
...
export class E2ETestFramework {
  ...
  private async executeSteps(
    steps: E2ETestStep[],
    stepResults: E2ETestResult["steps"],
  ): Promise<void> {
  ...
  private async executeStep(step: E2ETestStep): Promise<void> {
    ...
    switch (step.action) {
      ...
      case "expect":
        ...
        if (Math.random() < 0.1) {
          // 10% chance of assertion failure for testing
          throw new Error(
            `Assertion failed: ${step.element} is not ${step.assertion?.type}`,
          );
        }
        break;
