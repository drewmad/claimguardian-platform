...
describe('Property Management E2E Tests', () => {
  ...
  describe('Property Editing and Management', () => {
    beforeEach(async () => {
      ...
      await element(by.id('property-name-input')).typeText('Edit Test Property')
      await element(by.id('property-type-picker')).tap()
    ...
    test('should edit property details successfully', async () => {
      ...
      await element(by.id('property-name-input')).typeText('Edited Property Name')
    ...
    test('should add and manage property photos', async () => {
      ...
      await element(by.id('photo-description-input')).typeText('Front view of property showing main entrance')
    ...
    test('should create property assessment', async () => {
      ...
      await element(by.id('assessment-title-input')).typeText('Roof Inspection')
      ...
      await element(by.id('damage-description-input'))
        .typeText('Minor shingle damage observed after recent storm')
  ...
  describe('Offline Property Management', () => {
    test('should create property while offline', async () => {
      ...
      await detoxExpect(element(by.text('Saved offline - will sync when connected')))
        .toBeVisible()
