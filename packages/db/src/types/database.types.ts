...
export type Database = {
  ...
  public: {
    Tables: {
      ai_document_feedback: {
        Row: {
          ai_confidence_overall: number | null;
          ai_extracted_amount: number | null;
          ai_extracted_date: string | null;
          ai_extracted_from: string | null;
          ai_extracted_to: string | null;
          ai_extracted_type: string | null;
          ...
          user_corrected_from: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "ai_document_feedback_document_id_fkey";
            columns: ["document_id"];
            isOneToOne: false;
            referencedRelation: "intelligent_documents";
      ...
      claims: {
        Row: {
          ...
          user_id: string | null;
          version: number | null;
          weather_correlated: boolean | null;
        };
        Insert: {
          adjuster_company?: string | null;
          adjuster_email?: string | null;
      ...
      document_extractions_enhanced: {
        ...
        Relationships: [
          {
            foreignKeyName: "document_extractions_enhanced_approved_by_fkey";
            columns: ["approved_by"];
            isOneToOne: false;
            referencedRelation: "user_ai_usage_summary";
            referencedColumns: ["user_id"];
          ...
          {
            foreignKeyName: "document_extractions_enhanced_document_id_fkey";
            columns: ["document_id"];
            isOneToOne: false;
          ...
          },
          {
            ...
            columns: ["document_id"];
            isOneToOne: false;
            referencedRelation: "policy_documents_extended";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "document_extractions_enhanced_policy_id_fkey";
            columns: ["policy_id"];
            isOneToOne: false;
            referencedRelation: "policies";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "document_extractions_enhanced_previous_version_id_fkey";
            columns: ["previous_version_id"];
            isOneToOne: false;
            referencedRelation: "document_extractions_enhanced";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "document_extractions_enhanced_previous_version_id_fkey";
          ...
          {
            foreignKeyName: "document_extractions_enhanced_processed_by_fkey";
          ...
          {
            foreignKeyName: "document_extractions_enhanced_property_id_fkey";
            columns: ["property_id"];
            isOneToOne: false;
            referencedRelation: "properties";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "document_extractions_enhanced_reviewed_by_fkey";
            columns: ["reviewed_by"];
            isOneToOne: false;
            referencedRelation: "user_ai_usage_summary";
            referencedColumns: ["user_id"];
      ...
      extraction_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "extraction_history_extraction_id_fkey";
          ...
          {
            foreignKeyName: "extraction_history_performed_by_fkey";
      ...
      intelligent_documents: {
        Row: {
          ...
          ai_extracted_metadata: Json | null;
          ai_reasoning: string | null;
          ai_suggested_category:
            | Database["public"]["Enums"]["document_category"]
            | null;
      ...
      noaa_hurricane_tracks: {
        Row: {
          advisory_number: number | null;
          advisory_time: string | null;
          category: string | null;
          cone_of_uncertainty: unknown | null;
          created_at: string | null;
          current_location: unknown | null;
          forecast_positions: Json | null;
          forecast_track: Json | null;
          id: string;
          landfall_probability: Json | null;
          max_wind_speed: number | null;
          min_pressure: number | null;
          movement_direction: number | null;
          movement_speed: number | null;
          storm_id: string | null;
          storm_name: string | null;
          storm_surge_forecast: Json | null;
          updated_at: string | null;
          wind_radii: Json | null;
        };
        Insert: {
          advisory_number?: number | null;
          advisory_time?: string | null;
      ...
      noaa_river_gauges: {
        Row: {
          ...
          forecast_crest: number | null;
          forecast_crest_time: string | null;
          gauge_id: string;
          gauge_name: string | null;
          id: string;
          location: unknown | null;
          major_flood_stage: number | null;
          minor_flood_stage: number | null;
      ...
      noaa_weather_observations: {
        Row: {
          ...
          location: unknown | null;
          observation_time: string;
          precipitation_last_3hours: number | null;
          precipitation_last_6hours: number | null;
      ...
      policies: {
        ...
        Relationships: [
          {
            foreignKeyName: "policies_extraction_id_fkey";
            columns: ["extraction_id"];
            isOneToOne: false;
            referencedRelation: "document_extractions_enhanced";
            referencedColumns: ["id"];
    ...
    Views: {
      ...
      schema_health_summary: {
        Row: {
          largest_table_bytes: number | null;
          schema_name: unknown | null;
          size_bytes: number | null;
          smallest_table_bytes: number | null;
          table_count: number | null;
          total_size: string | null;
        };
        Relationships: [];
      };
      table_health_dashboard: {
        Row: {
    ...
    Functions: {
      ...
      confirm_document_processing: {
        Args: {
          doc_id: string;
          user_uuid: string;
          action: string;
          corrected_name?: string;
          corrected_category?: Database["public"]["Enums"]["document_category"];
      ...
      find_nearest_weather_station: {
        Args: { user_lat: number; user_lon: number; max_distance_km?: number };
        Returns: {
          station_id: string;
          station_name: string;
          distance_km: number;
      ...
      find_similar_weather_claims: {
        Args: { target_claim_id: string; similarity_threshold?: number };
        Returns: {
          similar_claim_id: string;
          similarity_score: number;
          common_weather_types: string[];
          severity_difference: number;
        }[];
      };
      generate_intelligent_document_name: {
        Args: {
          category_param: Database["public"]["Enums"]["document_category"];
          metadata_param: Json;
          florida_context_param?: Json;
        };
        Returns: string;
      };
      geography: {
      ...
      get_documents_pending_review: {
        ...
        Returns: {
          ...
          ai_suggested_category: Database["public"]["Enums"]["document_category"];
      ...
      get_property_overview: {
        Args: { days?: number; county_filter?: string };
        Returns: {
      ...
      get_property_risk_assessment: {
        Args: { min_risk_score?: number; county_filter?: string };
        Returns: {
          property_id: string;
          address: string;
          county: string;
      ...
      get_weather_correlation_summary: {
        Args: { user_id_param?: string };
        Returns: {
          total_claims: number;
          correlated_claims: number;
      ...
      process_document_intelligence: {
        Args: {
          doc_id: string;
          extracted_metadata: Json;
          suggested_category: Database["public"]["Enums"]["document_category"];
          confidence_scores?: Json;
          florida_context?: Json;
        };
        Returns: Json;
      };
...
export const Constants = {
  ...
  public: {
    Enums: {
      ...
      user_tier: ["free", "renter", "essential", "plus", "pro", "contractor"],
    },
  },
} as const;
