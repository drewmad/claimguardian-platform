...
export interface Attachment {
  ...
  name: string
  url: string
  type: 'Receipt' | 'Warranty' | 'Appraisal' | 'Certificate' | 'Manual' | 'Other'
  date?: string
  notes?: string
  file?: File
}
...
export interface HomeSystem {
  id: string
  type: 'Roof' | 'HVAC' | 'Electrical' | 'Plumbing' | 'Water Heater' | 'Pool Equipment' | 'Security' | 'Solar' | 'Other'
  customType?: string
  brand?: string
  model?: string
  age?: number
...
export interface Permit {
  ...
  permitNumber: string
  municipality: string
  status: 'Applied' | 'Approved' | 'Inspection Required' | 'Closed' | 'Denied' | 'Expired'
  issueDate?: string
...
export interface RoomInspection {
  id: string
  name: string
  type: 'Bedroom' | 'Bathroom' | 'Kitchen' | 'Living Room' | 'Dining Room' | 'Office' | 'Other'
...
export interface PropertyDocument {
  id: string
  name: string
  category: 'Deed' | 'Survey' | 'Title' | 'Tax' | 'Insurance' | 'Permit' | 'Warranty' | 'Other'
  date: string
  url: string
  description?: string
}
...
export interface Structure {
  id: string
  type: 'Shed' | 'Fence' | 'Pool' | 'Pool Enclosure' | 'Gazebo' | 'Garage' | 'Dock' | 'Other'
  customType?: string
  material: string
  dimensions?: string
  value?: number
