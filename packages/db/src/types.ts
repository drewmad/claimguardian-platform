...
export interface CoreProperty {
  ...
  occupancy_status: 'owner_occupied' | 'tenant_occupied' | 'vacant' | 'seasonal'
...
export interface Database {
  core: {
    Tables: {
      properties: {
        Row: CoreProperty
        Insert: Omit<CoreProperty, 'id' | 'created_at' | 'updated_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current' | 'full_address'>
        Update: Partial<Omit<CoreProperty, 'id' | 'created_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current' | 'full_address'>>
      }
      structures: {
        Row: CoreStructure
        Insert: Omit<CoreStructure, 'id' | 'created_at' | 'updated_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current'>
        Update: Partial<Omit<CoreStructure, 'id' | 'created_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current'>>
      }
      spaces: {
        Row: CoreSpace
        Insert: Omit<CoreSpace, 'id' | 'created_at' | 'updated_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current'>
        Update: Partial<Omit<CoreSpace, 'id' | 'created_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current'>>
      }
      scans: {
        Row: CoreScan
      ...
      digital_models: {
        ...
        Insert: Omit<CoreDigitalModel, 'id' | 'created_at' | 'updated_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current'>
        Update: Partial<Omit<CoreDigitalModel, 'id' | 'created_at' | 'version_id' | 'valid_from' | 'valid_to' | 'is_current'>>
      }
      current_properties: {
        Row: CoreProperty
        Insert: never
  ...
  reference: {
    ...
    Functions: {
      etl_florida_parcels_to_reference: {
        ...
        Returns: { processed_count: number; error_count: number; sample_errors: string[] }[]
      }
    }
  }
}
