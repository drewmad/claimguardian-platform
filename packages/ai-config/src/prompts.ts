...
export const PROMPT_TEMPLATES: Record<string, PromptTemplate> = {
  ...
  quickInventoryScan: {
    ...
    description: 'Analyzes one or more images to identify multiple items in bulk.',
    version: '1.0',
  ...
  detailedItemAnalysis: {
    ...
    description: 'Analyzes multiple images of a single item for a detailed record.',
    version: '1.0',
  ...
  guidedInventoryFrame: {
    ...
    description: 'Provides real-time guidance during a live video scan of an item.',
    version: '1.0',
  ...
  damageAssessment: {
    id: 'damageAssessment',
    description: 'Analyzes damage to property from images for insurance claims.',
    version: '1.0',
  ...
  documentSorter: {
    id: 'documentSorter',
    description: 'Classifies a document and extracts key information (e.g., warranty details).',
    version: '1.0',
  ...
  policyOcr: {
    id: 'policyOcr',
    description: 'Extracts key fields from an insurance declarations page image.',
    version: '1.0',
  ...
  settlementAnalysis: {
    ...
    description: 'Compares an insurance settlement offer against the user\'s claim data.',
    version: '1.0',
    template: `
  ...
  maintenanceSuggestions: {
    ...
    description: 'Generates maintenance suggestions for a specific home system.',
    version: '1.0',
  ...
  responseAnalysis: {
    id: 'responseAnalysis',
    description: 'Analyzes insurance company responses for key points and red flags.',
    version: '1.0',
