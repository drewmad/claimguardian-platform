...
class ClaudeLearningCLI {
  ...
  showWelcome() {
    console.log(
      chalk.blue.bold("🧠 CLAUDE LEARNING SYSTEM - INTERACTIVE MODE"),
    );
    console.log(chalk.blue("=".repeat(55)));
    console.log();
    console.log(
      chalk.green("✨ Welcome to the ClaimGuardian Claude Learning System!"),
    );
    console.log(
      chalk.gray(
        "This interactive mode demonstrates how Claude learns and improves.",
      ),
    );
    console.log();
    console.log(chalk.cyan("📊 Current Session Stats:"));
    console.log(
      chalk.white(`   Tasks Completed: ${this.stats.tasksCompleted}`),
    );
    console.log(
      chalk.white(`   Learnings Generated: ${this.stats.learningsGenerated}`),
    );
    console.log(
      chalk.white(`   Efficiency Gains: ${this.stats.efficiencyGains}%`),
    );
    console.log(
      chalk.white(`   Errors Resolved: ${this.stats.errorsResolved}`),
    );
    console.log();
  }
  ...
  async showMainMenu() {
    ...
    const choice = await this.askQuestion(
      chalk.cyan("Enter your choice (1-7): "),
    );
  ...
  async runLearningTask() {
    ...
    const typeChoice = await this.askQuestion(
      chalk.cyan("Enter task type (1-5): "),
    );
    ...
    const taskChoice = await this.askQuestion(
      chalk.cyan("Enter task number: "),
    );
  ...
  async simulateTaskExecution(taskType, taskDescription) {
    ...
    for (let i = 0; i < steps.length; i++) {
      ...
      if (i === 1) {
        console.log(
          chalk.cyan(
            '      🧠 Applying learned pattern: "Always validate props first"',
          ),
        );
      }
      if (i === 3) {
        console.log(
          chalk.cyan(
            "      🧠 Using optimized tool sequence from previous tasks",
          ),
        );
      }
    }
    ...
    console.log(
      chalk.gray(
        '   ✓ New Learning Captured: "Component prop validation pattern"',
      ),
    );
    console.log();
    ...
    console.log(
      chalk.white("   This learning will be applied to future similar tasks."),
    );
    console.log();
  ...
  async runCompleteDemo() {
    ...
    try {
      console.log(
        chalk.cyan(
          "Executing: apps/web/src/lib/claude/method-1-live-execution.ts",
        ),
      );
      console.log();
      ...
      console.log(
        chalk.white("1️⃣ Component Generation with Learning System..."),
      );
      await this.delay(2000);
      console.log(
        chalk.green(
          "   ✅ ClaimStatus component created with applied learnings!",
        ),
      );
      console.log();
      ...
      console.log(
        chalk.green(
          "   ✅ Authentication issue resolved using learned patterns!",
        ),
      );
      console.log();
      ...
      console.log(
        chalk.green(
          "   ✅ Analysis completed with optimization recommendations!",
        ),
      );
      console.log();
      ...
      console.log(
        chalk.white("   • 3 tasks completed with learning integration"),
      );
      console.log(chalk.white("   • Multiple patterns learned and applied"));
      console.log(
        chalk.white("   • 25-40% efficiency improvement demonstrated"),
      );
  ...
  async openDashboard() {
    ...
    console.log(
      chalk.cyan("URL: https://claimguardianai.com/admin?tab=claude-learning"),
    );
    console.log();
    ...
    try {
      ...
      console.log(
        chalk.yellow(
          "💡 Please manually visit: https://claimguardianai.com/admin?tab=claude-learning",
        ),
      );
    }
    ...
    console.log(
      chalk.white("   • System Overview - Task stats and efficiency metrics"),
    );
    console.log(chalk.white("   • Performance - Detailed execution analytics"));
    console.log(
      chalk.white("   • Learning Insights - Key learnings and improvements"),
    );
    console.log(chalk.white("   • Recent Activity - Live system events"));
    console.log(
      chalk.white("   • System Settings - Configure learning behavior"),
    );
    console.log();
  ...
  async showDocumentation() {
    ...
    console.log(
      chalk.white('     { filePath: "src/components/Notification.tsx" },'),
    );
    ...
    console.log(
      chalk.white(
        '   import { quickLearn } from "@/lib/claude/claude-complete-learning-system"',
      ),
    );
    console.log();
    console.log(chalk.white("   // Code generation"));
    console.log(
      chalk.white("   const generateComponent = quickLearn.codeGeneration("),
    );
    ...
    console.log(
      chalk.white("   • npm run claude:demo          - Run complete demo"),
    );
    console.log(
      chalk.white(
        "   • npm run claude:stats         - Show learning statistics",
      ),
    );
    console.log(
      chalk.white("   • npm run claude:dashboard     - Open admin dashboard"),
    );
    console.log(
      chalk.white(
        "   • npm run claude:test-system   - Test system integration",
      ),
    );
    console.log();
  ...
  exit() {
    console.log();
    console.log(
      chalk.green.bold("🎉 Thank you for using the Claude Learning System!"),
    );
    console.log(
      chalk.cyan(
        "💡 Continue using the learning system in your development workflow.",
      ),
    );
    console.log(
      chalk.yellow(
        "📊 Visit the admin dashboard to monitor learning progress.",
      ),
    );
    console.log();
    this.rl.close();
