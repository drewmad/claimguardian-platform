  ...
  const testQueries = [
    {
      ...
      query:
        "SELECT county_name, county_seat, region, coastal_county, property_search_url FROM get_florida_county('Miami-Dade')",
    },
    {
    ...
    },
    {
      ...
      query:
        "SELECT county_name FROM get_counties_by_region('Southeast') ORDER BY county_name",
    },
  ];
