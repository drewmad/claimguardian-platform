...
async function executeSQLFile() {
  try {
    ...
    const migrationRecord = await fetch(
      `${SUPABASE_URL}/rest/v1/supabase_migrations.schema_migrations`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    console.log(
      "1. Go to: https://app.supabase.com/project/tmlrvecuwgppbaynesji/editor",
    );
    console.log(
      "2. Copy the contents of: supabase/migrations/20250724_complete_property_schema.sql",
    );
