    ...
    with open(csv_file, 'r') as f:
        ...
        for row in reader:
            ...
            if len(batch) >= batch_size:
                ...
                print("INSERT INTO florida_parcels (co_no, parcel_id, own_name, phy_addr1, phy_city, phy_zipcd, lnd_val, jv) VALUES")
                print(",\n".join(batch))
...
if __name__ == "__main__":
    ...
    print("ON CONFLICT DO NOTHING;")
    print()
    print("-- Run this in SQL Editor: https://supabase.com/dashboard/project/tmlrvecuwgppbaynesji/sql/new")