...
if (!process.env.NEXT_PUBLIC_SUPABASE_URL) {
  ...
  console.error(
    "Please ensure .env.local is configured with Supabase credentials",
  );
  process.exit(1);
}
      ...
      objectives: [
        {
          ...
          status: "in_progress",
          progress_notes: [
            "Evacuation 75% complete",
            "Shelters at 60% capacity",
          ],
        },
        {
          id: "OBJ-002",
          ...
          status: "in_progress",
          progress_notes: [
            "Sandbagging operations underway",
            "Power grid secured",
          ],
        },
      ],
    ...
    alerts: [
      {
        ...
        message:
          "Hurricane Maria approaching Florida Keys. Category 3 storm with 120mph winds. All residents in evacuation zones A and B must evacuate immediately. Storm surge up to 12 feet expected.",
        priority: "flash",
        category: ["Met", "Safety"],
        urgency: "Immediate",
        severity: "Extreme",
    ...
    claims: [
      {
        ...
        type: "hurricane",
        description:
          "Severe roof damage from Hurricane Maria. Multiple shingles missing, water intrusion in master bedroom and living room.",
