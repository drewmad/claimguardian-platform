...
def load_env_vars():
    ...
    key_match = re.search(r'^NEXT_PUBLIC_SUPABASE_ANON_KEY=(.+)$', env_content, re.MULTILINE)
        ...
        try:
            ...
            for feature in features:
                ...
                record = {
                    ...
                    'county_fips': '087' if county.upper() == 'MONROE' else '000',  # TODO: Add proper FIPS mapping
                    ...
                    'year_built': attrs.get('ACT_YR_BLT') or attrs.get('EFF_YR_BLT') or None,
                    'living_area': attrs.get('TOT_LVG_AR') or None,
                    'land_area': attrs.get('LND_SQFOOT') / 43560 if attrs.get('LND_SQFOOT') else None,
