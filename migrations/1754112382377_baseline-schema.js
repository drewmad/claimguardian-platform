/**
 * @fileMetadata
 * @purpose This migration establishes the baseline schema for the database, including error logging functions.
 * @owner db-team
 * @status active
 */
...
exports.down = pgm => {
    ...
    pgm.sql(`
        ...
        -- Drop the columns from the error_logs table
        ALTER TABLE public.error_logs
        DROP COLUMN IF EXISTS status,
        DROP COLUMN IF EXISTS notes;

        -- Drop the type
        DROP TYPE IF EXISTS public.error_log_status;
    `);
};